...
class CDOTA_Modifier_Tiny_Tree_Grab : public CDOTA_Buff /*0x0*/  // sizeof 0x1AA0, align 0xFF [vtable] (server)
{
public:
    ...
    CHandle< CBaseEntity > m_hStolenTree; // offset 0x1A94, size 0x4, align 4
