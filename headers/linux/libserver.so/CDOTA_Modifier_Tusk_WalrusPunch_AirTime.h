...
class CDOTA_Modifier_Tusk_WalrusPunch_AirTime : public CDOTA_Buff /*0x0*/  // sizeof 0x1AB0, align 0xFF [vtable] (server)
{
public:
    ...
    float32 air_time; // offset 0x1AA8, size 0x4, align 4
