...
class CPlayer_MovementServices_Humanoid : public CPlayer_MovementServices /*0x0*/  // sizeof 0x290, align 0xFF [vtable] (server)
{
public:
    ...
    Vector m_vecSmoothedVelocity; // offset 0x284, size 0xC, align 4
};
