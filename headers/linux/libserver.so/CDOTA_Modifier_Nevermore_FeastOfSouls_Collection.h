...
class CDOTA_Modifier_Nevermore_FeastOfSouls_Collection : public CDOTA_Buff /*0x0*/  // sizeof 0x1AB8, align 0xFF [vtable] (server)
{
public:
    ...
    int32 m_nSoulsCollected; // offset 0x1A98, size 0x4, align 4
    char _pad_1A9C[0x4]; // offset 0x1A9C
    CUtlVector< CHandle< CBaseEntity > > m_hSoulCollectionList; // offset 0x1AA0, size 0x18, align 8
};
