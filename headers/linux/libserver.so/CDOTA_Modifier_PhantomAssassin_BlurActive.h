...
class CDOTA_Modifier_PhantomAssassin_BlurActive : public CDOTA_Buff /*0x0*/  // sizeof 0x1AA0, align 0xFF [vtable] (server)
{
public:
    ...
    CHandle< CBaseEntity > m_hVisibleEntity; // offset 0x1A8C, size 0x4, align 4
