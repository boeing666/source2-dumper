...
struct shard_model_desc_t  // sizeof 0x80, align 0xFF [vtable] (server)
{
    ...
    CNetworkUtlVectorBase< Vector2D > m_vecPanelVertices; // offset 0x40, size 0x18, align 8
    CNetworkUtlVectorBase< Vector4D > m_vInitialPanelVertices; // offset 0x58, size 0x18, align 8
