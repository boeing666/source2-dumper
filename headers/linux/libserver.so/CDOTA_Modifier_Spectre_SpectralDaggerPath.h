...
class CDOTA_Modifier_Spectre_SpectralDaggerPath : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC0, align 0xFF [vtable] (server)
{
public:
    char _pad_0000[0x1A90]; // offset 0x0
    CUtlVector< CHandle< CBaseEntity > > m_hUnitsInPath; // offset 0x1A90, size 0x18, align 8
