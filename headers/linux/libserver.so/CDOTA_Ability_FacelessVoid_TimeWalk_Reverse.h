...
class CDOTA_Ability_FacelessVoid_TimeWalk_Reverse : public CDOTABaseAbility /*0x0*/, public CHorizontalMotionController /*0x860*/  // sizeof 0x890, align 0x8 [vtable] (server)
{
public:
    ...
    VectorWS m_vStartLocation; // offset 0x880, size 0xC, align 4
