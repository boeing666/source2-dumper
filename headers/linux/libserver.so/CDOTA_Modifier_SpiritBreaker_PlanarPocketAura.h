...
class CDOTA_Modifier_SpiritBreaker_PlanarPocketAura : public CDOTA_Buff /*0x0*/  // sizeof 0x1A90, align 0xFF [vtable] (server)
{
public:
    char _pad_0000[0x1A78]; // offset 0x0
    bool m_bHasActivated; // offset 0x1A78, size 0x1, align 1
