...
class CDOTABehaviorPet : public CDOTABehaviorCompanion /*0x0*/  // sizeof 0x300, align 0xFF [vtable] (server)
{
public:
    ...
    CountdownTimer m_RareIdleTimer; // offset 0x2B8, size 0x18, align 8
    bool m_bIsEmoting; // offset 0x2D0, size 0x1, align 1
    char _pad_02D1[0x3]; // offset 0x2D1
    CHandle< CDOTA_BaseNPC > m_hEmoteTarget; // offset 0x2D4, size 0x4, align 4
    CountdownTimer m_EmoteTimer; // offset 0x2D8, size 0x18, align 8
    int32 m_nEmoteActivity; // offset 0x2F0, size 0x4, align 4
    CHandle< CBaseEntity > m_tempGoalEntity; // offset 0x2F4, size 0x4, align 4
    bool m_bFollowingTempGoal; // offset 0x2F8, size 0x1, align 1
    char _pad_02F9[0x3]; // offset 0x2F9
    int32 m_event_dota_illusions_created; // offset 0x2FC, size 0x4, align 4
};
