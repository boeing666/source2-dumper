...
struct PlayerResourcePlayerData_t  // sizeof 0xF0, align 0xFF [vtable] (server)
{
    ...
    CNetworkUtlVectorBase< PlayerID_t > m_vecPrivateCoachPlayerIDs; // offset 0x68, size 0x18, align 8
