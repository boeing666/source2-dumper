...
public:
    ...
    Vector m_vFanOriginOffset; // offset 0xBBC, size 0xC, align 4
    Vector m_vDirection; // offset 0xBC8, size 0xC, align 4
    bool m_bPushTowardsInfoTarget; // offset 0xBD4, size 0x1, align 1
    bool m_bPushAwayFromInfoTarget; // offset 0xBD5, size 0x1, align 1
    char _pad_0BD6[0xA]; // offset 0xBD6
