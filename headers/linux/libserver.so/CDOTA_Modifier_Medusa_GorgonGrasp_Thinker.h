...
class CDOTA_Modifier_Medusa_GorgonGrasp_Thinker : public CDOTA_Buff /*0x0*/  // sizeof 0x1A88, align 0xFF [vtable] (server)
{
public:
    ...
    bool m_bDelayed; // offset 0x1A84, size 0x1, align 1
