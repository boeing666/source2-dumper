...
class CDOTA_Modifier_Item_Harpoon : public CDOTA_Buff_Item /*0x0*/  // sizeof 0x1AB8, align 0xFF [vtable] (server)
{
public:
    ...
    AttackRecord_t m_nBonusProcAttackRecord; // offset 0x1AB0, size 0x2, align 255
