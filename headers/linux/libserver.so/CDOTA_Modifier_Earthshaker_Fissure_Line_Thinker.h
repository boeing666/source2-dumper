...
class CDOTA_Modifier_Earthshaker_Fissure_Line_Thinker : public CDOTA_Buff /*0x0*/  // sizeof 0x1AE0, align 0xFF [vtable] (server)
{
public:
    ...
    CUtlVector< CDOTA_BaseNPC* > thinkerEntities; // offset 0x1AC8, size 0x18, align 8
};
