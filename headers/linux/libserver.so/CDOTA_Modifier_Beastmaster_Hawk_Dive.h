...
class CDOTA_Modifier_Beastmaster_Hawk_Dive : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC0, align 0xFF [vtable] (server)
{
public:
    ...
    int32 dive_damage; // offset 0x1AB8, size 0x4, align 4
    float32 dive_root_duration; // offset 0x1ABC, size 0x4, align 4
};
