...
class CDOTA_Modifier_Phoenix_Sun : public CDOTA_Buff /*0x0*/  // sizeof 0x1A98, align 0xFF [vtable] (server)
{
public:
    ...
    CHandle< CBaseEntity > m_hSecondaryTarget; // offset 0x1A8C, size 0x4, align 4
    int32 m_iAttackCount; // offset 0x1A90, size 0x4, align 4
    int32 creep_attacks_count; // offset 0x1A94, size 0x4, align 4
};
