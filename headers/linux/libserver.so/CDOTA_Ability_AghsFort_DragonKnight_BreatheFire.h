...
class CDOTA_Ability_AghsFort_DragonKnight_BreatheFire : public CDOTABaseAbility /*0x0*/  // sizeof 0x880, align 0x8 [vtable] (server)
{
public:
    char _pad_0000[0x85C]; // offset 0x0
    ParticleIndex_t m_nPreviewFX; // offset 0x85C, size 0x4, align 255
    int32 start_radius; // offset 0x860, size 0x4, align 4
    int32 end_radius; // offset 0x864, size 0x4, align 4
