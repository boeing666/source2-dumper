...
class CDOTA_Ability_Shadow_Demon_Shadow_Poison : public CDOTABaseAbility /*0x0*/  // sizeof 0x8B0, align 0x8 [vtable] (server)
{
public:
    char _pad_0000[0x860]; // offset 0x0
    CUtlVector< CHandle< CBaseEntity > > m_hPoisonedUnits; // offset 0x860, size 0x18, align 8
    bool m_bHitDisruptedUnit; // offset 0x878, size 0x1, align 1
