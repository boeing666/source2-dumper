...
class CDOTA_Modifier_VoidSpirit_AetherRemnantThinker : public CDOTA_Buff /*0x0*/  // sizeof 0x1AA0, align 0xFF [vtable] (server)
{
public:
    ...
    CHandle< CBaseEntity > m_hRemnant; // offset 0x1A8C, size 0x4, align 4
    CHandle< CBaseEntity > m_hPartnerRemnant; // offset 0x1A90, size 0x4, align 4
