...
struct ActiveModelConfig_t  // sizeof 0xA0, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
    ...
    CUtlLeanVector< bool > m_vecAssociatedEntityCollidesWithHierarchy; // offset 0x70, size 0x10, align 8
    CUtlLeanVector< bool > m_vecAssociatedEntityCollidesOutsideHierarchy; // offset 0x80, size 0x10, align 8
    char _pad_0090[0x10]; // offset 0x90
};
