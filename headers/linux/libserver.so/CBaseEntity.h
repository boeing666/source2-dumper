...
class CBaseEntity : public CEntityInstance /*0x0*/  // sizeof 0x788, align 0x8 [vtable] (server)
{
public:
    ...
    bool m_bTakesDamage; // offset 0x5C0, size 0x1, align 1
    char _pad_05C1[0x7]; // offset 0x5C1
    ...
    Vector m_vecBaseVelocity; // offset 0x6A8, size 0xC, align 4
    int32 m_nPushEnumCount; // offset 0x6B4, size 0x4, align 4 | MNotSaved
    CCollisionProperty* m_pCollision; // offset 0x6B8, size 0x8, align 8 | MNotSaved
    CHandle< CBaseEntity > m_hEffectEntity; // offset 0x6C0, size 0x4, align 4
    CHandle< CBaseEntity > m_hOwnerEntity; // offset 0x6C4, size 0x4, align 4
    uint32 m_fEffects; // offset 0x6C8, size 0x4, align 4
    CHandle< CBaseEntity > m_hGroundEntity; // offset 0x6CC, size 0x4, align 4
    int32 m_nGroundBodyIndex; // offset 0x6D0, size 0x4, align 4
    float32 m_flFriction; // offset 0x6D4, size 0x4, align 4
    float32 m_flElasticity; // offset 0x6D8, size 0x4, align 4
    float32 m_flGravityScale; // offset 0x6DC, size 0x4, align 4
    float32 m_flTimeScale; // offset 0x6E0, size 0x4, align 4
    float32 m_flWaterLevel; // offset 0x6E4, size 0x4, align 4
    bool m_bGravityDisabled; // offset 0x6E8, size 0x1, align 1
    bool m_bAnimatedEveryTick; // offset 0x6E9, size 0x1, align 1
    char _pad_06EA[0x2]; // offset 0x6EA
    float32 m_flActualGravityScale; // offset 0x6EC, size 0x4, align 4
    bool m_bGravityActuallyDisabled; // offset 0x6F0, size 0x1, align 1
    bool m_bDisableLowViolence; // offset 0x6F1, size 0x1, align 1
    uint8 m_nWaterType; // offset 0x6F2, size 0x1, align 1
    char _pad_06F3[0x1]; // offset 0x6F3
    int32 m_iEFlags; // offset 0x6F4, size 0x4, align 4
    CEntityIOOutput m_OnUser1; // offset 0x6F8, size 0x18, align 255
    CEntityIOOutput m_OnUser2; // offset 0x710, size 0x18, align 255
    CEntityIOOutput m_OnUser3; // offset 0x728, size 0x18, align 255
    CEntityIOOutput m_OnUser4; // offset 0x740, size 0x18, align 255
    int32 m_iInitialTeamNum; // offset 0x758, size 0x4, align 4
    GameTime_t m_flNavIgnoreUntilTime; // offset 0x75C, size 0x4, align 255
    QAngle m_vecAngVelocity; // offset 0x760, size 0xC, align 4
    bool m_bNetworkQuantizeOriginAndAngles; // offset 0x76C, size 0x1, align 1
    bool m_bLagCompensate; // offset 0x76D, size 0x1, align 1
    char _pad_076E[0x2]; // offset 0x76E
    CHandle< CBaseEntity > m_pBlocker; // offset 0x770, size 0x4, align 4
    float32 m_flLocalTime; // offset 0x774, size 0x4, align 4
    float32 m_flVPhysicsUpdateLocalTime; // offset 0x778, size 0x4, align 4
    BloodType m_nBloodType; // offset 0x77C, size 0x4, align 4
    CPulseGraphInstance_ServerEntity* m_pPulseGraphInstance; // offset 0x780, size 0x8, align 8 | MKV3TransferSaveOpsForField
};
