...
class CDOTA_Modifier_CrystalMaiden_FreezingField : public CDOTA_Buff /*0x0*/  // sizeof 0x1B10, align 0xFF [vtable] (server)
{
public:
    ...
    CUtlVector< CHandle< CBaseEntity > > m_hHitEntities; // offset 0x1AD8, size 0x18, align 8
    CUtlVector< CHandle< CBaseEntity > > m_hHitHeroes; // offset 0x1AF0, size 0x18, align 8
    bool m_bHitInvisibleHero; // offset 0x1B08, size 0x1, align 1
    char _pad_1B09[0x3]; // offset 0x1B09
    int32 can_move; // offset 0x1B0C, size 0x4, align 4
};
