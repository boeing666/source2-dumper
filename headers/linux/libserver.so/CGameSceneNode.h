...
class CGameSceneNode  // sizeof 0x120, align 0x10 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
    ...
    CUtlStringToken m_name; // offset 0xF0, size 0x4, align 4
    char _pad_00F4[0x14]; // offset 0xF4
    CUtlStringToken m_hierarchyAttachName; // offset 0x108, size 0x4, align 4
    float32 m_flClientLocalScale; // offset 0x10C, size 0x4, align 4
