...
class CDOTA_Modifier_Largo_Frogstomp_Thinker : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC0, align 0xFF [vtable] (server)
{
public:
    ...
    int32 nNumTicks; // offset 0x1A9C, size 0x4, align 4
    bool m_bGrantedGem; // offset 0x1AA0, size 0x1, align 1
    bool m_bPendingDestroy; // offset 0x1AA1, size 0x1, align 1
    char _pad_1AA2[0x6]; // offset 0x1AA2
    CUtlVector< CHandle< CBaseEntity > > m_hHitHeroes; // offset 0x1AA8, size 0x18, align 8
};
