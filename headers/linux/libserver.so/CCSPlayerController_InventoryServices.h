...
class CCSPlayerController_InventoryServices : public CPlayerControllerComponent /*0x0*/  // sizeof 0xFE8, align 0xFF [vtable] (server)
{
public:
    ...
    CUtlVectorEmbeddedNetworkVar< ServerAuthoritativeWeaponSlot_t > m_vecServerAuthoritativeWeaponSlots; // offset 0xF58, size 0x90, align 8
};
