...
class CDOTA_Modifier_XP_Fountain_Aura : public CDOTA_Buff /*0x0*/  // sizeof 0x1AA0, align 0xFF [vtable] (server)
{
public:
    ...
    ParticleIndex_t m_nFxProgress; // offset 0x1A98, size 0x4, align 255
