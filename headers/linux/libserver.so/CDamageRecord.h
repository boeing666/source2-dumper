...
class CDamageRecord  // sizeof 0x78, align 0xFF [vtable] (server)
{
public:
    char _pad_0000[0x30]; // offset 0x0
    CHandle< CCSPlayerPawn > m_PlayerDamager; // offset 0x30, size 0x4, align 4
    CHandle< CCSPlayerPawn > m_PlayerRecipient; // offset 0x34, size 0x4, align 4
