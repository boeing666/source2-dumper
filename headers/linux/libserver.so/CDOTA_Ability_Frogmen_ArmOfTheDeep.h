...
class CDOTA_Ability_Frogmen_ArmOfTheDeep : public CDOTABaseAbility /*0x0*/  // sizeof 0x8A8, align 0x8 [vtable] (server)
{
public:
    ...
    int32 projectile_width; // offset 0x888, size 0x4, align 4
    float32 neutral_shared_cooldown; // offset 0x88C, size 0x4, align 4
