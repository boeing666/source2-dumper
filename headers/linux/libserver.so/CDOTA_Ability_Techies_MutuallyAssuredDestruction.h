...
public:
    ...
    ParticleIndex_t m_castParticle; // offset 0x86C, size 0x4, align 255
    GameTime_t m_ActiveExplodeTime; // offset 0x870, size 0x4, align 255
    GameTime_t m_PassiveExplodeTime; // offset 0x874, size 0x4, align 255
