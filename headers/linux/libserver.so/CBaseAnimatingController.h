...
class CBaseAnimatingController : public CSkeletonAnimationController /*0x0*/  // sizeof 0x4C8, align 0xFF [vtable] (server)
{
public:
    ...
    CSequenceTransitioner2 m_SequenceTransitioner; // offset 0x370, size 0x158, align 255
};
