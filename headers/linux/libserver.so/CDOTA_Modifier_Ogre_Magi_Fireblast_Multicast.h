...
class CDOTA_Modifier_Ogre_Magi_Fireblast_Multicast : public CDOTA_Buff /*0x0*/  // sizeof 0x1A88, align 0xFF [vtable] (server)
{
public:
    char _pad_0000[0x1A78]; // offset 0x0
    CHandle< CDOTA_BaseNPC > m_hTarget; // offset 0x1A78, size 0x4, align 4
