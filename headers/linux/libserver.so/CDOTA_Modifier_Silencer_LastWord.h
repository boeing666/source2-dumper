...
class CDOTA_Modifier_Silencer_LastWord : public CDOTA_Buff /*0x0*/  // sizeof 0x1A90, align 0xFF [vtable] (server)
{
public:
    char _pad_0000[0x1A78]; // offset 0x0
    float32 duration; // offset 0x1A78, size 0x4, align 4
    bool spellcast; // offset 0x1A7C, size 0x1, align 1
    ...
    float32 int_multiplier; // offset 0x1A88, size 0x4, align 4
