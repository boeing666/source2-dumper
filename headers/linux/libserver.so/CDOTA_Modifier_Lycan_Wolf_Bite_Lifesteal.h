...
class CDOTA_Modifier_Lycan_Wolf_Bite_Lifesteal : public CDOTA_Buff /*0x0*/  // sizeof 0x1AA0, align 0xFF [vtable] (server)
{
public:
    ...
    CUtlVector< CHandle< CBaseEntity > > m_vecTargets; // offset 0x1A88, size 0x18, align 8
};
