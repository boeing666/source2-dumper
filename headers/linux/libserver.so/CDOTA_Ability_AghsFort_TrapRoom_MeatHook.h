...
class CDOTA_Ability_AghsFort_TrapRoom_MeatHook : public CDOTABaseAbility /*0x0*/, public CHorizontalMotionController /*0x860*/  // sizeof 0x8C0, align 0x8 [vtable] (server)
{
public:
