...
class CDOTA_Modifier_Pugna_LifeDrain : public CDOTA_Buff /*0x0*/  // sizeof 0x1AB8, align 0xFF [vtable] (server)
{
public:
    ...
    CHandle< CBaseEntity > m_hWard; // offset 0x1A98, size 0x4, align 4
