...
class CDOTA_Ability_Frogmen_CongregationOfTheDeep : public CDOTABaseAbility /*0x0*/  // sizeof 0x8A8, align 0x8 [vtable] (server)
{
public:
    ...
    int32 projectile_count; // offset 0x888, size 0x4, align 4
