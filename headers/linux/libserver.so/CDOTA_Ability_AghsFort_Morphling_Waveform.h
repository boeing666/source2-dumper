...
class CDOTA_Ability_AghsFort_Morphling_Waveform : public CDOTABaseAbility /*0x0*/, public CHorizontalMotionController /*0x860*/  // sizeof 0x888, align 0x8 [vtable] (server)
{
public:
    ...
    ParticleIndex_t m_nPreviewFX; // offset 0x884, size 0x4, align 255
};
