...
class CCommentarySystem  // sizeof 0x60, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
    char _pad_0000[0x12]; // offset 0x0
    ...
    CUtlVector< modifiedconvars_t > m_ModifiedConvars; // offset 0x20, size 0x18, align 8
