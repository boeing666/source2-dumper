...
class CDOTA_Modifier_SandKing_SandStorm : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC0, align 0xFF [vtable] (server)
{
public:
    ...
    CHandle< CBaseEntity > m_hThinker; // offset 0x1AA8, size 0x4, align 4
