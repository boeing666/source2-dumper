...
class CDOTA_Modifier_AghsFort_AssaultCaptain_SunRay : public CDOTA_Buff /*0x0*/  // sizeof 0x1AF0, align 0xFF [vtable] (server)
{
public:
    ...
    CHandle< CBaseEntity >[8] m_hVisionThinkers; // offset 0x1AC0, size 0x20, align 4
    CHandle< CBaseEntity > m_hBeamEnd; // offset 0x1AE0, size 0x4, align 4
    bool m_bCreatedVisionThinkers; // offset 0x1AE4, size 0x1, align 1
    char _pad_1AE5[0x3]; // offset 0x1AE5
    CHandle< CBaseEntity > m_hBeamEndSound; // offset 0x1AE8, size 0x4, align 4
