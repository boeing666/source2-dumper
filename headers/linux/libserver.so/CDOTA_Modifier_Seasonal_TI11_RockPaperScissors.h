...
class CDOTA_Modifier_Seasonal_TI11_RockPaperScissors : public CDOTA_Buff /*0x0*/  // sizeof 0x1AA8, align 0xFF [vtable] (server)
{
public:
    ...
    bool m_bFirstThink; // offset 0x1A98, size 0x1, align 1
    char _pad_1A99[0x3]; // offset 0x1A99
    PlayerID_t m_nRevealOpponentPlayerID; // offset 0x1A9C, size 0x4, align 255
    char _pad_1AA0[0x8]; // offset 0x1AA0
};
