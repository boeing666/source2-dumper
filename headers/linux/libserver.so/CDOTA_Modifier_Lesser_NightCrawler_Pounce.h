...
class CDOTA_Modifier_Lesser_NightCrawler_Pounce : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC0, align 0xFF [vtable] (server)
{
public:
    ...
    float32 pounce_speed; // offset 0x1AA8, size 0x4, align 4
    float32 pounce_acceleration; // offset 0x1AAC, size 0x4, align 4
    int32 pounce_radius; // offset 0x1AB0, size 0x4, align 4
    int32 pounce_damage; // offset 0x1AB4, size 0x4, align 4
    float32 leash_duration; // offset 0x1AB8, size 0x4, align 4
