...
class CAddUpdateNode : public CBinaryUpdateNode /*0x0*/  // sizeof 0x98, align 0x8 [vtable] (animgraphlib) {MGetKV3ClassDefaults}
{
public:
    ...
    bool m_bApplyScale; // offset 0x97, size 0x1, align 1
};
