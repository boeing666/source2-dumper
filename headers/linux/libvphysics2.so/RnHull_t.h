...
struct RnHull_t  // sizeof 0xF8, align 0x8 (physicslib) {MGetKV3ClassDefaults}
{
    ...
    float32 m_flMinCentroidRadius; // offset 0x10, size 0x4, align 4
    AABB_t m_Bounds; // offset 0x14, size 0x18, align 255
    Vector m_vOrthographicAreas; // offset 0x2C, size 0xC, align 4
    matrix3x4_t m_MassProperties; // offset 0x38, size 0x30, align 4
    float32 m_flVolume; // offset 0x68, size 0x4, align 4
    float32 m_flSurfaceArea; // offset 0x6C, size 0x4, align 4
