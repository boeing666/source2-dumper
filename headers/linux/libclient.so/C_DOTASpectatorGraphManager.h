...
class C_DOTASpectatorGraphManager  // sizeof 0x9F0, align 0xFF [vtable] (client)
{
public:
    ...
    char _pad_09D0[0x18]; // offset 0x9D0
    uint32 m_unDataChangedCount; // offset 0x9E8, size 0x4, align 4
