...
struct AI_BaseNPC_DebugSnapshotData_t : public DebugSnapshotBaseStructuredData_t /*0x0*/  // sizeof 0x188, align 0x8 [vtable] (client) {MGetKV3ClassDefaults MPropertyFriendlyName}
{
    ...
    AI_BaseNPCAnimGraph_DebugSnapshotData_t animgraph; // offset 0x70, size 0x48, align 8
    AI_Navigator_DebugSnapshotData_t navigator; // offset 0xB8, size 0x50, align 8
    AI_MotorServices_DebugSnapshotData_t motorServices; // offset 0x108, size 0x38, align 8
    AI_FacingServices_DebugSnapshotData_t facingServices; // offset 0x140, size 0x48, align 8
};
