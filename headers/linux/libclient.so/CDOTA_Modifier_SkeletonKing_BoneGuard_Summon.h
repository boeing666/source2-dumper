...
class CDOTA_Modifier_SkeletonKing_BoneGuard_Summon : public CDOTA_Buff /*0x0*/  // sizeof 0x1AA0, align 0xFF [vtable] (client)
{
public:
    ...
    float32 vampiric_aura; // offset 0x1A88, size 0x4, align 4
    ...
    int32 m_nVampiricAura; // offset 0x1A9C, size 0x4, align 4
};
