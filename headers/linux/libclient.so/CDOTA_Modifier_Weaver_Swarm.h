...
class CDOTA_Modifier_Weaver_Swarm : public CDOTA_Buff /*0x0*/  // sizeof 0x1AA0, align 0xFF [vtable] (client)
{
public:
    ...
    CHandle< C_BaseEntity > m_hAttachTarget; // offset 0x1A98, size 0x4, align 4
