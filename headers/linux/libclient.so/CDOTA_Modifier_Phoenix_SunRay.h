...
class CDOTA_Modifier_Phoenix_SunRay : public CDOTA_Buff /*0x0*/  // sizeof 0x1AF8, align 0xFF [vtable] (client)
{
public:
    ...
    CHandle< C_BaseEntity >[8] m_hVisionThinkers; // offset 0x1ACC, size 0x20, align 4
    CHandle< C_BaseEntity > m_hBeamEnd; // offset 0x1AEC, size 0x4, align 4
    bool m_bCreatedVisionThinkers; // offset 0x1AF0, size 0x1, align 1
    char _pad_1AF1[0x3]; // offset 0x1AF1
    CHandle< C_BaseEntity > m_hBeamEndSound; // offset 0x1AF4, size 0x4, align 4
};
