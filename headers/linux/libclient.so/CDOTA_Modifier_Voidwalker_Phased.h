...
class CDOTA_Modifier_Voidwalker_Phased : public CDOTA_Buff /*0x0*/  // sizeof 0x1A98, align 0xFF [vtable] (client)
{
public:
    ...
    float32 m_flStartTime; // offset 0x1A84, size 0x4, align 4
    float32 m_flFadeTime; // offset 0x1A88, size 0x4, align 4
