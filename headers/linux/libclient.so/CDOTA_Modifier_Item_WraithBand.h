...
class CDOTA_Modifier_Item_WraithBand : public CDOTA_Buff_Item /*0x0*/  // sizeof 0x1A70, align 0xFF [vtable] (client)
{
public:
    ...
    float32 bonus_armor; // offset 0x1A68, size 0x4, align 4
