...
class CDOTA_Modifier_Item_Witch_Blade : public CDOTA_Buff_Item /*0x0*/  // sizeof 0x1AA8, align 0xFF [vtable] (client)
{
public:
    ...
    int32 projectile_speed; // offset 0x1A8C, size 0x4, align 4
