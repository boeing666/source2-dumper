...
class CDOTA_Modifier_EarthSpirit_Magnetize : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC0, align 0xFF [vtable] (client)
{
public:
    ...
    CUtlVector< CHandle< C_BaseEntity > > m_hExplodedRocks; // offset 0x1AA0, size 0x18, align 8
