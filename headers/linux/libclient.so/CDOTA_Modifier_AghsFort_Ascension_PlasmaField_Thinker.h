...
class CDOTA_Modifier_AghsFort_Ascension_PlasmaField_Thinker : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC0, align 0xFF [vtable] (client)
{
public:
    ...
    bool m_bWindingUp; // offset 0x1A64, size 0x1, align 1
    ...
    int32 damage_min; // offset 0x1AA8, size 0x4, align 4
    int32 damage_max; // offset 0x1AAC, size 0x4, align 4
    ...
    float32 windup_time; // offset 0x1ABC, size 0x4, align 4
};
