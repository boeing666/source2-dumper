...
public:
    ...
    bool m_bSampleRootMotion; // offset 0xC, size 0x1, align 1
    bool m_bAllowLooping; // offset 0xD, size 0x1, align 1
    int16 m_nDataSlotIdx; // offset 0xE, size 0x2, align 2
    int16 m_nResetTimeValueNodeIdx; // offset 0x10, size 0x2, align 2
