...
class CDOTA_Modifier_Item_AbyssalBlade : public CDOTA_Buff_Item /*0x0*/  // sizeof 0x1AB8, align 0xFF [vtable] (client)
{
public:
    ...
    int32 hp_regen_amp; // offset 0x1AB0, size 0x4, align 4
    int32 slow_resistance; // offset 0x1AB4, size 0x4, align 4
};
