...
class CDOTA_Modifier_KeeperOfTheLight_Will_O_Wisp_Aura : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC8, align 0xFF [vtable] (client)
{
public:
    ...
    CUtlVector< CHandle< C_BaseEntity > > m_vecDamagedEntities; // offset 0x1AA8, size 0x18, align 8
