...
class CSurvivorsPowerUpDefinition_InstantAttack : public CSurvivorsPowerUpDefinition /*0x0*/  // sizeof 0x788, align 0x8 [vtable] (client) {MGetKV3ClassDefaults MVDataRoot}
{
public:
