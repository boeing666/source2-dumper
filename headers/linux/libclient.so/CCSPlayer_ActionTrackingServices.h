...
class CCSPlayer_ActionTrackingServices : public CPlayerPawnComponent /*0x0*/  // sizeof 0x1A0, align 0xFF [vtable] (client)
{
public:
    ...
    WeaponPurchaseTracker_t m_weaponCarryOverIntoThisRound; // offset 0x130, size 0x70, align 255
};
