...
class CDOTA_Modifier_Kez_GrapplingClaw_Movement : public CDOTA_Buff /*0x0*/  // sizeof 0x1B00, align 0xFF [vtable] (client)
{
public:
    ...
    CHandle< C_BaseEntity > m_hTarget; // offset 0x1AE8, size 0x4, align 4
    ...
    char _pad_1AFA[0x6]; // offset 0x1AFA
};
