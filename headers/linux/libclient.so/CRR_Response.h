...
class CRR_Response  // sizeof 0x1D0, align 0x8 (client) {MGetKV3ClassDefaults}
{
public:
    ...
    ResponseParams m_Params; // offset 0x160, size 0x1C, align 1
    float32 m_fMatchScore; // offset 0x17C, size 0x4, align 4 | MNotSaved
    bool m_bAnyMatchingRulesInCooldown; // offset 0x180, size 0x1, align 1 | MNotSaved
    char _pad_0181[0x7]; // offset 0x181
