...
class CTeamTrackedStatDefinition  // sizeof 0x30, align 0x8 (client) {MGetKV3ClassDefaults MVDataRoot}
{
public:
    ...
    ETeamTrackedStatImpl m_eStatImpl; // offset 0xC, size 0x4, align 4 | MPropertyDescription
