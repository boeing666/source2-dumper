...
class CDOTA_Modifier_TrollWarlord_Whirling_Axes_Melee : public CDOTA_Buff /*0x0*/  // sizeof 0x1AE8, align 0xFF [vtable] (client)
{
public:
    ...
    CUtlVector< CHandle< C_BaseEntity > > hitEntities; // offset 0x1AB8, size 0x18, align 8
    CUtlVector< CHandle< C_BaseEntity > > m_hAxes; // offset 0x1AD0, size 0x18, align 8
};
