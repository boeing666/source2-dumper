...
class CDOTA_Modifier_FacelessVoid_TimeLock_ForceProc : public CDOTA_Buff /*0x0*/  // sizeof 0x1A90, align 0xFF [vtable] (client)
{
public:
    ...
    CHandle< C_DOTA_BaseNPC > m_hTarget; // offset 0x1A88, size 0x4, align 4
