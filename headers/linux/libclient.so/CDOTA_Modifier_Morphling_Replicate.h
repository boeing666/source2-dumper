...
class CDOTA_Modifier_Morphling_Replicate : public CDOTA_Buff /*0x0*/  // sizeof 0x1B10, align 0xFF [vtable] (client)
{
public:
    char _pad_0000[0x1A78]; // offset 0x0
    CHandle< C_BaseEntity > m_hTinyTreeWearable; // offset 0x1A78, size 0x4, align 4
    ...
    CUtlVector< C_EconItemView* > m_vecOriginalItems; // offset 0x1AB0, size 0x18, align 8
