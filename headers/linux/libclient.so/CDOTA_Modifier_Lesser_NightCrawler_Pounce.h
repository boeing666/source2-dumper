...
class CDOTA_Modifier_Lesser_NightCrawler_Pounce : public CDOTA_Buff /*0x0*/  // sizeof 0x1A90, align 0xFF [vtable] (client)
{
public:
    ...
    float32 leash_duration; // offset 0x1A8C, size 0x4, align 4
};
