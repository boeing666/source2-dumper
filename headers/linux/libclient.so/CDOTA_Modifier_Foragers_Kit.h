...
class CDOTA_Modifier_Foragers_Kit : public CDOTA_Buff_Item /*0x0*/  // sizeof 0x1AB8, align 0xFF [vtable] (client)
{
public:
    ...
    C_DotaTree* m_pForagingTree; // offset 0x1AA8, size 0x8, align 8
