...
class CDOTA_Modifier_Marci_Lunge_TrackingMotion : public CDOTA_Buff /*0x0*/  // sizeof 0x1AB0, align 0xFF [vtable] (client)
{
public:
    ...
    CHandle< C_BaseEntity > m_hBounceEntity; // offset 0x1AA8, size 0x4, align 4
    CHandle< C_BaseEntity > m_hBounceEntityClient; // offset 0x1AAC, size 0x4, align 4
};
