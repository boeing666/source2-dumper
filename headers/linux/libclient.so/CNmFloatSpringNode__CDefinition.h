...
public:
    ...
    float32 m_flStartValue; // offset 0xC, size 0x4, align 4
    float32 m_flHertz; // offset 0x10, size 0x4, align 4
    float32 m_flDampingRatio; // offset 0x14, size 0x4, align 4
    int16 m_nInputValueNodeIdx; // offset 0x18, size 0x2, align 2
    bool m_bUseStartValue; // offset 0x1A, size 0x1, align 1
