...
class CDOTA_Modifier_AbyssalUnderlord_Firestorm_Thinker : public CDOTA_Buff /*0x0*/  // sizeof 0x1AA0, align 0xFF [vtable] (client)
{
public:
    ...
    CHandle< C_BaseEntity > m_hTarget; // offset 0x1A98, size 0x4, align 4
