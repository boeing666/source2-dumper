...
class C_DOTA_Ability_Meepo_MegaMeepo : public C_DOTABaseAbility /*0x0*/  // sizeof 0x868, align 0x8 [vtable] (client)
{
public:
    ...
    CUtlVector< int32 > hFlingHandles; // offset 0x848, size 0x18, align 8
    bool m_bHasSwappedAbilities; // offset 0x860, size 0x1, align 1
