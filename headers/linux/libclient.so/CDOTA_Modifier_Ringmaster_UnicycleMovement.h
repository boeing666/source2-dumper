...
class CDOTA_Modifier_Ringmaster_UnicycleMovement : public CDOTA_Buff /*0x0*/  // sizeof 0x1AB0, align 0xFF [vtable] (client)
{
public:
    ...
    CHandle< C_BaseEntity > m_hUnicycle; // offset 0x1AAC, size 0x4, align 4
};
