...
class C_BaseEntity : public CEntityInstance /*0x0*/  // sizeof 0x780, align 0x8 [vtable] (client)
{
public:
    ...
    bool m_bTakesDamage; // offset 0x4C5, size 0x1, align 1 | MNotSaved
    ...
    Vector m_vecBaseVelocity; // offset 0x688, size 0xC, align 4 | MNotSaved
    CHandle< C_BaseEntity > m_hEffectEntity; // offset 0x694, size 0x4, align 4 | MNotSaved
    CHandle< C_BaseEntity > m_hOwnerEntity; // offset 0x698, size 0x4, align 4
    MoveCollide_t m_MoveCollide; // offset 0x69C, size 0x1, align 1 | MNotSaved
    MoveType_t m_MoveType; // offset 0x69D, size 0x1, align 1
    MoveType_t m_nActualMoveType; // offset 0x69E, size 0x1, align 1
    char _pad_069F[0x1]; // offset 0x69F
    float32 m_flWaterLevel; // offset 0x6A0, size 0x4, align 4 | MNotSaved
    uint32 m_fEffects; // offset 0x6A4, size 0x4, align 4 | MNotSaved
    CHandle< C_BaseEntity > m_hGroundEntity; // offset 0x6A8, size 0x4, align 4 | MNotSaved
    int32 m_nGroundBodyIndex; // offset 0x6AC, size 0x4, align 4 | MNotSaved
    float32 m_flFriction; // offset 0x6B0, size 0x4, align 4 | MNotSaved
    float32 m_flElasticity; // offset 0x6B4, size 0x4, align 4 | MNotSaved
    float32 m_flGravityScale; // offset 0x6B8, size 0x4, align 4 | MNotSaved
    float32 m_flTimeScale; // offset 0x6BC, size 0x4, align 4 | MNotSaved
    bool m_bAnimatedEveryTick; // offset 0x6C0, size 0x1, align 1 | MNotSaved
    bool m_bGravityDisabled; // offset 0x6C1, size 0x1, align 1
    char _pad_06C2[0x2]; // offset 0x6C2
    GameTime_t m_flNavIgnoreUntilTime; // offset 0x6C4, size 0x4, align 255 | MNotSaved
    uint16 m_hThink; // offset 0x6C8, size 0x2, align 2 | MNotSaved
    char _pad_06CA[0xE]; // offset 0x6CA
    uint8 m_fBBoxVisFlags; // offset 0x6D8, size 0x1, align 1 | MNotSaved
    char _pad_06D9[0x3]; // offset 0x6D9
    float32 m_flActualGravityScale; // offset 0x6DC, size 0x4, align 4
    bool m_bGravityActuallyDisabled; // offset 0x6E0, size 0x1, align 1
    bool m_bPredictable; // offset 0x6E1, size 0x1, align 1 | MNotSaved
    bool m_bRenderWithViewModels; // offset 0x6E2, size 0x1, align 1
    char _pad_06E3[0x1]; // offset 0x6E3
    int32 m_nFirstPredictableCommand; // offset 0x6E4, size 0x4, align 4 | MNotSaved
    int32 m_nLastPredictableCommand; // offset 0x6E8, size 0x4, align 4 | MNotSaved
    CHandle< C_BaseEntity > m_hOldMoveParent; // offset 0x6EC, size 0x4, align 4 | MNotSaved
    CParticleProperty m_Particles; // offset 0x6F0, size 0x28, align 8 | MNotSaved
    char _pad_0718[0x8]; // offset 0x718
    QAngle m_vecAngVelocity; // offset 0x720, size 0xC, align 4
    int32 m_DataChangeEventRef; // offset 0x72C, size 0x4, align 4 | MNotSaved
    CUtlVector< CEntityHandle > m_dependencies; // offset 0x730, size 0x18, align 8 | MNotSaved
    int32 m_nCreationTick; // offset 0x748, size 0x4, align 4 | MNotSaved
    char _pad_074C[0x15]; // offset 0x74C
    bool m_bAnimTimeChanged; // offset 0x761, size 0x1, align 1 | MNotSaved
    bool m_bSimulationTimeChanged; // offset 0x762, size 0x1, align 1 | MNotSaved
    char _pad_0763[0xD]; // offset 0x763
    CUtlString m_sUniqueHammerID; // offset 0x770, size 0x8, align 8 | MNotSaved
    BloodType m_nBloodType; // offset 0x778, size 0x4, align 4
