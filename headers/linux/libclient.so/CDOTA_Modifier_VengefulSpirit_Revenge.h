...
class CDOTA_Modifier_VengefulSpirit_Revenge : public CDOTA_Buff /*0x0*/  // sizeof 0x1AA0, align 0xFF [vtable] (client)
{
public:
    ...
    CHandle< C_DOTA_BaseNPC > m_hCurrentBuffHolder; // offset 0x1A98, size 0x4, align 4
