...
class CDOTA_Modifier_Lich_Chain_Frost_Thinker : public CDOTA_Buff /*0x0*/  // sizeof 0x1A90, align 0xFF [vtable] (client)
{
public:
    ...
    CHandle< C_BaseEntity > m_hAvoidTarget; // offset 0x1A8C, size 0x4, align 4
};
