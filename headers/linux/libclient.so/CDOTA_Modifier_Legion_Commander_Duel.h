...
class CDOTA_Modifier_Legion_Commander_Duel : public CDOTA_Buff /*0x0*/  // sizeof 0x1AF0, align 0xFF [vtable] (client)
{
public:
    ...
    CHandle< C_BaseEntity > m_hPartner; // offset 0x1A9C, size 0x4, align 4
    float32 m_flNextTime; // offset 0x1AA0, size 0x4, align 4
    char _pad_1AA4[0x4]; // offset 0x1AA4
    CUtlVector< CHandle< C_BaseEntity > > hAlreadyHitList; // offset 0x1AA8, size 0x18, align 8
    CUtlVector< CHandle< C_BaseEntity > > m_hAllyAssisters; // offset 0x1AC0, size 0x18, align 8
    CUtlVector< CHandle< C_BaseEntity > > m_hEnemyAssisters; // offset 0x1AD8, size 0x18, align 8
};
