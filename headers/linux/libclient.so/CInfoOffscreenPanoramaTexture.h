...
class CInfoOffscreenPanoramaTexture : public C_PointEntity /*0x0*/  // sizeof 0x978, align 0x8 [vtable] (client) {MEntityAllowsPortraitWorldSpawn}
{
public:
    char _pad_0000[0x77C]; // offset 0x0
    bool m_bDisabled; // offset 0x77C, size 0x1, align 1
    bool m_bEnableMipGen; // offset 0x77D, size 0x1, align 1
    ...
    char _pad_07F8[0x158]; // offset 0x7F8
    bool m_bCheckCSSClasses; // offset 0x950, size 0x1, align 1 | MNotSaved
    char _pad_0951[0x27]; // offset 0x951
};
