...
class C_SoundEventEntity : public C_BaseEntity /*0x0*/  // sizeof 0x838, align 0x8 [vtable] (client)
{
public:
    uint8_t m_bClientSideOnly : 1; // offset 0x0 | MNotSaved
    char _pad_0001[0x77B]; // offset 0x1
    bool m_bStartOnSpawn; // offset 0x77C, size 0x1, align 1
    bool m_bToLocalPlayer; // offset 0x77D, size 0x1, align 1
    bool m_bStopOnNew; // offset 0x77E, size 0x1, align 1
    bool m_bSaveRestore; // offset 0x77F, size 0x1, align 1
    bool m_bSavedIsPlaying; // offset 0x780, size 0x1, align 1
    char _pad_0781[0x3]; // offset 0x781
    float32 m_flSavedElapsedTime; // offset 0x784, size 0x4, align 4
