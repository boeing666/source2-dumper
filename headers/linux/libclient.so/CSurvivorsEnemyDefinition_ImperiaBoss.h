...
public:
    ...
    float32 m_flBurningGroundImpactDamage; // offset 0x284, size 0x4, align 4
    float32 m_flBurningGroundImpactRadius; // offset 0x288, size 0x4, align 4
    float32 m_flBurningGroundImpactSpawnDelay; // offset 0x28C, size 0x4, align 4
    float32 m_flBurningGroundFlamesDuration; // offset 0x290, size 0x4, align 4
    float32 m_flBurningGroundDoTDuration; // offset 0x294, size 0x4, align 4
    float32 m_flBurningGroundDoTDamage; // offset 0x298, size 0x4, align 4
    float32 m_flBurningGroundImpactStunDuration; // offset 0x29C, size 0x4, align 4
    int32 m_nBurningGroundInstancesPerEnrageLevel; // offset 0x2A0, size 0x4, align 4
