...
struct C_fogplayerparams_t  // sizeof 0x40, align 0x8 [vtable trivial_dtor] (client) {MGetKV3ClassDefaults}
{
    char _pad_0000[0x8]; // offset 0x0
    CHandle< C_FogController > m_hCtrl; // offset 0x8, size 0x4, align 4
    float32 m_flTransitionTime; // offset 0xC, size 0x4, align 4
    Color m_OldColor; // offset 0x10, size 0x4, align 4
    ...
    Color m_NewColor; // offset 0x28, size 0x4, align 4
