...
class CDOTA_Ability_AncientApparition_IceAge : public C_DOTABaseAbility /*0x0*/  // sizeof 0x838, align 0x8 [vtable] (client)
{
public:
    char _pad_0000[0x824]; // offset 0x0
    float32 radius; // offset 0x824, size 0x4, align 4
    int32 health_degen; // offset 0x828, size 0x4, align 4
