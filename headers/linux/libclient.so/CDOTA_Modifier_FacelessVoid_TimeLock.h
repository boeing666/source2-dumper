...
class CDOTA_Modifier_FacelessVoid_TimeLock : public CDOTA_Buff /*0x0*/  // sizeof 0x1AD8, align 0xFF [vtable] (client)
{
public:
    ...
    CUtlOrderedMap< CHandle< C_DOTA_BaseNPC >, int32 > m_mapTargets; // offset 0x1AB0, size 0x28, align 8
};
