...
class CGameSceneNode  // sizeof 0x140, align 0x10 [vtable] (client) {MGetKV3ClassDefaults}
{
public:
    ...
    CNetworkOriginCellCoordQuantizedVector m_vecOrigin; // offset 0x80, size 0x30, align 255
    char _pad_00B0[0x8]; // offset 0xB0
    QAngle m_angRotation; // offset 0xB8, size 0xC, align 4
    float32 m_flScale; // offset 0xC4, size 0x4, align 4
    ...
    CUtlStringToken m_name; // offset 0x10C, size 0x4, align 4
    char _pad_0110[0x18]; // offset 0x110
    CUtlStringToken m_hierarchyAttachName; // offset 0x128, size 0x4, align 4
    float32 m_flClientLocalScale; // offset 0x12C, size 0x4, align 4
    char _pad_0130[0x10]; // offset 0x130
};
