...
class C_OP_PercentageBetweenTransformLerpCPs : public CParticleFunctionOperator /*0x0*/  // sizeof 0x2C0, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    int32 m_nOutputStartCP; // offset 0x2A8, size 0x4, align 4 | MPropertyFriendlyName
    int32 m_nOutputStartField; // offset 0x2AC, size 0x4, align 4 | MPropertyFriendlyName
    int32 m_nOutputEndCP; // offset 0x2B0, size 0x4, align 4 | MPropertyFriendlyName
    int32 m_nOutputEndField; // offset 0x2B4, size 0x4, align 4 | MPropertyFriendlyName
