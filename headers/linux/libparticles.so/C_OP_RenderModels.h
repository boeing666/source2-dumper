...
public:
    ...
    bool m_bOnlyRenderInEffectsBloomPass; // offset 0x21A, size 0x1, align 1 | MPropertyFriendlyName MPropertySortPriority
    bool m_bOnlyRenderInEffectsWaterPass; // offset 0x21B, size 0x1, align 1 | MPropertyFriendlyName MPropertySortPriority MPropertySuppressExpr
    bool m_bUseMixedResolutionRendering; // offset 0x21C, size 0x1, align 1 | MPropertyFriendlyName MPropertySortPriority
    bool m_bOnlyRenderInEffecsGameOverlay; // offset 0x21D, size 0x1, align 1 | MPropertyFriendlyName MPropertySortPriority MPropertySuppressExpr
