...
class C_INIT_SetFloatAttributeToVectorExpression : public CParticleFunctionInitializer /*0x0*/  // sizeof 0x1068, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
