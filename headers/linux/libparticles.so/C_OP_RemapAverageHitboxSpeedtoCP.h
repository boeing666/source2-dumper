...
class C_OP_RemapAverageHitboxSpeedtoCP : public CParticleFunctionPreEmission /*0x0*/  // sizeof 0xEE8, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    char _pad_0000[0x1DC]; // offset 0x0
    int32 m_nInControlPointNumber; // offset 0x1DC, size 0x4, align 4 | MPropertyFriendlyName
    int32 m_nOutControlPointNumber; // offset 0x1E0, size 0x4, align 4 | MPropertyFriendlyName
    int32 m_nField; // offset 0x1E4, size 0x4, align 4 | MPropertyFriendlyName MPropertyAttributeChoiceName
    ParticleHitboxDataSelection_t m_nHitboxDataType; // offset 0x1E8, size 0x4, align 4 | MPropertyFriendlyName
    ...
    CParticleCollectionVecInput m_vecComparisonVelocity; // offset 0x7B8, size 0x6B0, align 8 | MPropertyFriendlyName MPropertySuppressExpr
    char[128] m_HitboxSetName; // offset 0xE68, size 0x80, align 1 | MPropertyFriendlyName
};
