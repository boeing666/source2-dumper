...
public:
    ...
    int32 m_nOutputCPField; // offset 0x1E8, size 0x4, align 4 | MPropertyFriendlyName
    bool m_bSetOnce; // offset 0x1EC, size 0x1, align 1 | MPropertyFriendlyName
    ...
    float32 m_flMaxTraceLength; // offset 0x200, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_flLOSScale; // offset 0x204, size 0x4, align 4 | MPropertyFriendlyName
    bool m_bLOS; // offset 0x208, size 0x1, align 1 | MPropertyFriendlyName
    char[128] m_CollisionGroupName; // offset 0x209, size 0x80, align 1 | MPropertyFriendlyName
    char _pad_0289[0x3]; // offset 0x289
    ParticleTraceSet_t m_nTraceSet; // offset 0x28C, size 0x4, align 4 | MPropertyFriendlyName
    ParticleParentSetMode_t m_nSetParent; // offset 0x290, size 0x4, align 4 | MPropertyFriendlyName
