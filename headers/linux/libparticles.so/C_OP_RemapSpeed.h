...
class C_OP_RemapSpeed : public CParticleFunctionOperator /*0x0*/  // sizeof 0x1F0, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    ParticleSetMethod_t m_nSetMethod; // offset 0x1E4, size 0x4, align 4 | MPropertyFriendlyName
    bool m_bIgnoreDelta; // offset 0x1E8, size 0x1, align 1 | MPropertyFriendlyName
