...
class C_OP_SetControlPointToCenter : public CParticleFunctionPreEmission /*0x0*/  // sizeof 0x1F0, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    bool m_bUseAvgParticlePos; // offset 0x1E4, size 0x1, align 1 | MPropertyFriendlyName MVectorIsCoordinate
