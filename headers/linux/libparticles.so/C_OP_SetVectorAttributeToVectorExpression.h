...
class C_OP_SetVectorAttributeToVectorExpression : public CParticleFunctionOperator /*0x0*/  // sizeof 0x1120, align 0x10 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    char _pad_10B9[0x67]; // offset 0x10B9
};
