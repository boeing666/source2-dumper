...
class C_INIT_Orient2DRelToCP : public CParticleFunctionInitializer /*0x0*/  // sizeof 0x1E8, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    float32 m_flRotOffset; // offset 0x1DC, size 0x4, align 4 | MPropertyFriendlyName
