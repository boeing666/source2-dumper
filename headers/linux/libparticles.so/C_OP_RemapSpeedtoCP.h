...
class C_OP_RemapSpeedtoCP : public CParticleFunctionPreEmission /*0x0*/  // sizeof 0x1F8, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    bool m_bUseDeltaV; // offset 0x1F0, size 0x1, align 1 | MPropertyFriendlyName
