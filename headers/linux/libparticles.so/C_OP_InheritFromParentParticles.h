...
class C_OP_InheritFromParentParticles : public CParticleFunctionOperator /*0x0*/  // sizeof 0x1E0, align 0x8 [vtable] (particles) {MParticleMaxVersion MParticleReplacementOp MGetKV3ClassDefaults}
{
public:
