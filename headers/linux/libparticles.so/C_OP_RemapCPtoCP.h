...
public:
    ...
    int32 m_nInputControlPoint; // offset 0x1DC, size 0x4, align 4 | MPropertyFriendlyName
    int32 m_nOutputControlPoint; // offset 0x1E0, size 0x4, align 4 | MPropertyFriendlyName
    int32 m_nInputField; // offset 0x1E4, size 0x4, align 4 | MPropertyFriendlyName MPropertyAttributeChoiceName
    int32 m_nOutputField; // offset 0x1E8, size 0x4, align 4 | MPropertyFriendlyName MPropertyAttributeChoiceName
    ...
    bool m_bDerivative; // offset 0x1FC, size 0x1, align 1 | MPropertyFriendlyName
    char _pad_01FD[0x3]; // offset 0x1FD
    float32 m_flInterpRate; // offset 0x200, size 0x4, align 4 | MPropertyFriendlyName
