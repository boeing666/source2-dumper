...
class C_OP_RemapCPtoScalar : public CParticleFunctionOperator /*0x0*/  // sizeof 0x200, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    int32 m_nField; // offset 0x1D8, size 0x4, align 4 | MPropertyFriendlyName MPropertyAttributeChoiceName
    ...
    float32 m_flEndTime; // offset 0x1F0, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_flInterpRate; // offset 0x1F4, size 0x4, align 4 | MPropertyFriendlyName
