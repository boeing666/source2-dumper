...
class C_OP_SetFloat : public CParticleFunctionOperator /*0x0*/  // sizeof 0x4E0, align 0x10 [vtable] (particles) {MGetKV3ClassDefaults MGPUParticleFunction}
{
public:
    ...
    CPerParticleFloatInput m_Lerp; // offset 0x340, size 0x168, align 8 | MPropertyFriendlyName
    char _pad_04A8[0x38]; // offset 0x4A8
};
