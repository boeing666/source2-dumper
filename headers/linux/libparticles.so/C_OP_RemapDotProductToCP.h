...
public:
    ...
    int32 m_nInputCP1; // offset 0x1DC, size 0x4, align 4 | MPropertyFriendlyName
    int32 m_nInputCP2; // offset 0x1E0, size 0x4, align 4 | MPropertyFriendlyName
    int32 m_nOutputCP; // offset 0x1E4, size 0x4, align 4 | MPropertyFriendlyName
    int32 m_nOutVectorField; // offset 0x1E8, size 0x4, align 4 | MPropertyFriendlyName MPropertyAttributeChoiceName
