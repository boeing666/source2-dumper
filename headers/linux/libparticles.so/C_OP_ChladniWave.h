...
class C_OP_ChladniWave : public CParticleFunctionOperator /*0x0*/  // sizeof 0x1510, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    CPerParticleVecInput m_vecWaveLength; // offset 0x7A0, size 0x6B0, align 8 | MPropertyFriendlyName
    CPerParticleVecInput m_vecHarmonics; // offset 0xE50, size 0x6B0, align 8 | MPropertyFriendlyName
    ParticleSetMethod_t m_nSetMethod; // offset 0x1500, size 0x4, align 4 | MPropertyFriendlyName
    int32 m_nLocalSpaceControlPoint; // offset 0x1504, size 0x4, align 4 | MPropertyFriendlyName
    bool m_b3D; // offset 0x1508, size 0x1, align 1 | MPropertyFriendlyName
    char _pad_1509[0x7]; // offset 0x1509
};
