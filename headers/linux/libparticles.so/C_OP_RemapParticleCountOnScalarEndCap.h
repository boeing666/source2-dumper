...
class C_OP_RemapParticleCountOnScalarEndCap : public CParticleFunctionOperator /*0x0*/  // sizeof 0x1F0, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    int32 m_nInputMin; // offset 0x1D4, size 0x4, align 4 | MPropertyFriendlyName
    int32 m_nInputMax; // offset 0x1D8, size 0x4, align 4 | MPropertyFriendlyName
    ...
    bool m_bBackwards; // offset 0x1E4, size 0x1, align 1 | MPropertyFriendlyName
