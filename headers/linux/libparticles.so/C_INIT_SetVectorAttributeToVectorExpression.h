...
class C_INIT_SetVectorAttributeToVectorExpression : public CParticleFunctionInitializer /*0x0*/  // sizeof 0x10D0, align 0x10 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
