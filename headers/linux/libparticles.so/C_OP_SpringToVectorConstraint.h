...
class C_OP_SpringToVectorConstraint : public CParticleFunctionConstraint /*0x0*/  // sizeof 0xE48, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    CPerParticleVecInput m_vecAnchorVector; // offset 0x798, size 0x6B0, align 8 | MPropertyFriendlyName
};
