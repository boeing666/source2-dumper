...
class C_INIT_InheritFromParentParticles : public CParticleFunctionInitializer /*0x0*/  // sizeof 0x1F0, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults MGPUParticleFunction}
{
public:
    ...
    int32 m_nIncrement; // offset 0x1E4, size 0x4, align 4 | MPropertyFriendlyName
