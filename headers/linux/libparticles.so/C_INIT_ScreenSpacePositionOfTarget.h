...
class C_INIT_ScreenSpacePositionOfTarget : public CParticleFunctionInitializer /*0x0*/  // sizeof 0xA08, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    char _pad_0000[0x1E0]; // offset 0x0
    CPerParticleVecInput m_vecTargetPosition; // offset 0x1E0, size 0x6B0, align 8 | MPropertyFriendlyName MVectorIsCoordinate
