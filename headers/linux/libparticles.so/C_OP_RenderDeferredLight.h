...
public:
    ...
    bool m_bUseAlphaTestWindow; // offset 0x21A, size 0x1, align 1 | MPropertyFriendlyName MPropertySuppressExpr
    bool m_bUseTexture; // offset 0x21B, size 0x1, align 1 | MPropertyFriendlyName
