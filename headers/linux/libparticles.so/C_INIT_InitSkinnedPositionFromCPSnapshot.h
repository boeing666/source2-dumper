...
public:
    ...
    bool m_bRandom; // offset 0x1E4, size 0x1, align 1 | MPropertyFriendlyName MPropertySuppressExpr
    char _pad_01E5[0x3]; // offset 0x1E5
    int32 m_nRandomSeed; // offset 0x1E8, size 0x4, align 4 | MPropertyFriendlyName MPropertySuppressExpr
    bool m_bRigid; // offset 0x1EC, size 0x1, align 1 | MPropertyFriendlyName
    bool m_bSetNormal; // offset 0x1ED, size 0x1, align 1 | MPropertyFriendlyName
    bool m_bIgnoreDt; // offset 0x1EE, size 0x1, align 1 | MPropertyFriendlyName
    char _pad_01EF[0x1]; // offset 0x1EF
    float32 m_flMinNormalVelocity; // offset 0x1F0, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_flMaxNormalVelocity; // offset 0x1F4, size 0x4, align 4 | MPropertyFriendlyName
    SnapshotIndexType_t m_nIndexType; // offset 0x1F8, size 0x4, align 4 | MPropertyFriendlyName
