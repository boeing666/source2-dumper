...
class C_OP_RampScalarSplineSimple : public CParticleFunctionOperator /*0x0*/  // sizeof 0x210, align 0x10 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    bool m_bEaseOut; // offset 0x204, size 0x1, align 1 | MPropertyFriendlyName
    char _pad_0205[0xB]; // offset 0x205
};
