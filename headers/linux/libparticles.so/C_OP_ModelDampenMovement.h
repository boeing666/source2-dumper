...
class C_OP_ModelDampenMovement : public CParticleFunctionOperator /*0x0*/  // sizeof 0x918, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    CPerParticleVecInput m_vecPosOffset; // offset 0x260, size 0x6B0, align 8 | MPropertyFriendlyName MVectorIsCoordinate
    float32 m_fDrag; // offset 0x910, size 0x4, align 4 | MPropertyFriendlyName MPropertyAttributeRange
