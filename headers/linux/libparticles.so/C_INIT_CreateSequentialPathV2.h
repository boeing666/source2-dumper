...
class C_INIT_CreateSequentialPathV2 : public CParticleFunctionInitializer /*0x0*/  // sizeof 0x520, align 0x10 [vtable] (particles) {MParticleMinVersion MGetKV3ClassDefaults MGPUParticleFunction}
{
public:
