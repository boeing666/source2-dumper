...
class C_OP_DragRelativeToPlane : public CParticleFunctionOperator /*0x0*/  // sizeof 0xB78, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    CParticleCollectionVecInput m_vecPlaneNormal; // offset 0x4C0, size 0x6B0, align 8 | MPropertyFriendlyName MVectorIsCoordinate
    int32 m_nControlPointNumber; // offset 0xB70, size 0x4, align 4 | MPropertyFriendlyName
