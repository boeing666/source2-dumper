...
class C_INIT_RemapTransformOrientationToRotations : public CParticleFunctionInitializer /*0x0*/  // sizeof 0x250, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
