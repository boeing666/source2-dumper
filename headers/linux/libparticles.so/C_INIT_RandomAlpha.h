...
public:
    ...
    int32 m_nAlphaMin; // offset 0x1E0, size 0x4, align 4 | MPropertyFriendlyName MPropertyAttributeRange
    int32 m_nAlphaMax; // offset 0x1E4, size 0x4, align 4 | MPropertyFriendlyName MPropertyAttributeRange
    char _pad_01E8[0x8]; // offset 0x1E8
    float32 m_flAlphaRandExponent; // offset 0x1F0, size 0x4, align 4 | MPropertyFriendlyName
