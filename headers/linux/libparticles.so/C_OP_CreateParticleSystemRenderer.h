...
class C_OP_CreateParticleSystemRenderer : public CParticleFunctionRenderer /*0x0*/  // sizeof 0x900, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    CPerParticleVecInput m_AggregationPos; // offset 0x250, size 0x6B0, align 8 | MPropertyFriendlyName
};
