...
class C_OP_RemapTransformVisibilityToScalar : public CParticleFunctionOperator /*0x0*/  // sizeof 0x258, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    float32 m_flOutputMin; // offset 0x24C, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_flOutputMax; // offset 0x250, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_flRadius; // offset 0x254, size 0x4, align 4 | MPropertyFriendlyName
};
