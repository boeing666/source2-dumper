...
class C_OP_RemapVectorComponentToScalar : public CParticleFunctionOperator /*0x0*/  // sizeof 0x1E0, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    int32 m_nComponent; // offset 0x1D8, size 0x4, align 4 | MPropertyFriendlyName MPropertyAttributeChoiceName
