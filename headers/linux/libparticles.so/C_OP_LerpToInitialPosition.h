...
class C_OP_LerpToInitialPosition : public CParticleFunctionOperator /*0x0*/  // sizeof 0xB78, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    CParticleCollectionVecInput m_vecScale; // offset 0x4C8, size 0x6B0, align 8 | MPropertyFriendlyName
};
