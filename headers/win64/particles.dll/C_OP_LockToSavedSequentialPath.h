...
public:
    ...
    float32 m_flFadeStart; // offset 0x1E4, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_flFadeEnd; // offset 0x1E8, size 0x4, align 4 | MPropertyFriendlyName
    bool m_bCPPairs; // offset 0x1EC, size 0x1, align 1 | MPropertyFriendlyName
