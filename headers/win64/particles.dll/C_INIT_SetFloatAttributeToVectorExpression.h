...
class C_INIT_SetFloatAttributeToVectorExpression : public CParticleFunctionInitializer /*0x0*/  // sizeof 0x1120, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    CParticleRemapFloatInput m_flOutputRemap; // offset 0xFA0, size 0x178, align 8 | MPropertyFriendlyName
