...
class C_OP_RemapScalarOnceTimed : public CParticleFunctionOperator /*0x0*/  // sizeof 0x200, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    char _pad_0000[0x1E0]; // offset 0x0
    bool m_bProportional; // offset 0x1E0, size 0x1, align 1 | MPropertyFriendlyName
    ...
    float32 m_flRemapTime; // offset 0x1FC, size 0x4, align 4 | MPropertyFriendlyName
};
