...
class C_OP_SequenceFromModel : public CParticleFunctionOperator /*0x0*/  // sizeof 0x1F8, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    ParticleAttributeIndex_t m_nFieldOutputAnim; // offset 0x1E0, size 0x4, align 255 | MPropertyFriendlyName MPropertyAttributeChoiceName
    ...
    ParticleSetMethod_t m_nSetMethod; // offset 0x1F4, size 0x4, align 4 | MPropertyFriendlyName
};
