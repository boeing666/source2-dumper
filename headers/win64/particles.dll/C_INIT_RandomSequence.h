...
class C_INIT_RandomSequence : public CParticleFunctionInitializer /*0x0*/  // sizeof 0x228, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults MGPUParticleFunction}
{
public:
    ...
    char _pad_0208[0x20]; // offset 0x208
};
