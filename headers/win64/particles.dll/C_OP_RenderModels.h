...
class C_OP_RenderModels : public CParticleFunctionRenderer /*0x0*/  // sizeof 0x2CA8, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    char[64] m_ClothEffectName; // offset 0x1A19, size 0x40, align 1 | MPropertyFriendlyName MPropertySortPriority
    char _pad_1A59[0x7]; // offset 0x1A59
    ...
    char _pad_2C64[0x44]; // offset 0x2C64
};
