...
class CBaseTrailRenderer : public CBaseRendererSource2 /*0x0*/  // sizeof 0x30E8, align 0xFF [vtable abstract] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    bool m_bClampV; // offset 0x30E0, size 0x1, align 1 | MPropertyStartGroup MPropertyFriendlyName MPropertySortPriority
    char _pad_30E1[0x7]; // offset 0x30E1
};
