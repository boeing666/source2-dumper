...
struct TextureGroup_t  // sizeof 0xC18, align 0x8 (particles) {MGetKV3ClassDefaults}
{
    ...
    CParticleCollectionRendererFloatInput m_flTextureBlend; // offset 0x38, size 0x178, align 8 | MPropertyFriendlyName MPropertySuppressExpr
    TextureControls_t m_TextureControls; // offset 0x1B0, size 0xA68, align 8 | MPropertyFriendlyName MPropertySuppressExpr
};
