...
struct TextureGroup_t  // sizeof 0xBD8, align 0x8 (particles) {MGetKV3ClassDefaults}
{
    ...
    CParticleCollectionRendererFloatInput m_flTextureBlend; // offset 0x38, size 0x170, align 8 | MPropertyFriendlyName MPropertySuppressExpr
    TextureControls_t m_TextureControls; // offset 0x1A8, size 0xA30, align 8 | MPropertyFriendlyName MPropertySuppressExpr
};
