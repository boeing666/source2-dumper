...
class C_OP_PercentageBetweenTransforms : public CParticleFunctionOperator /*0x0*/  // sizeof 0x2D0, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    CParticleTransformInput m_TransformStart; // offset 0x1F8, size 0x68, align 8 | MPropertyFriendlyName
    CParticleTransformInput m_TransformEnd; // offset 0x260, size 0x68, align 8 | MPropertyFriendlyName
