...
public:
    ...
    float32 m_flFadeOutTimeMin; // offset 0x1E0, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_flFadeOutTimeMax; // offset 0x1E4, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_flFadeOutTimeExp; // offset 0x1E8, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_flFadeBias; // offset 0x1EC, size 0x4, align 4 | MPropertyFriendlyName
