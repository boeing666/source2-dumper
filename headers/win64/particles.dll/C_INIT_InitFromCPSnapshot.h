...
class C_INIT_InitFromCPSnapshot : public CParticleFunctionInitializer /*0x0*/  // sizeof 0x4E8, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults MGPUParticleFunction}
{
public:
