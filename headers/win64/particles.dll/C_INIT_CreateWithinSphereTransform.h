...
class C_INIT_CreateWithinSphereTransform : public CParticleFunctionInitializer /*0x0*/  // sizeof 0x1C50, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults MGPUParticleFunction}
{
public:
