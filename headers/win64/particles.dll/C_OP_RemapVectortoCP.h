...
class C_OP_RemapVectortoCP : public CParticleFunctionOperator /*0x0*/  // sizeof 0x1E8, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    int32 m_nParticleNumber; // offset 0x1E0, size 0x4, align 4 | MPropertyFriendlyName
