...
class C_OP_RemapVelocityToVector : public CParticleFunctionOperator /*0x0*/  // sizeof 0x1E8, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    bool m_bNormalize; // offset 0x1E0, size 0x1, align 1 | MPropertyFriendlyName
