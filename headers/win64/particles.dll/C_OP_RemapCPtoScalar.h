...
class C_OP_RemapCPtoScalar : public CParticleFunctionOperator /*0x0*/  // sizeof 0x210, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    ParticleSetMethod_t m_nSetMethod; // offset 0x208, size 0x4, align 4 | MPropertyFriendlyName
