...
class C_OP_RemapVisibilityScalar : public CParticleFunctionOperator /*0x0*/  // sizeof 0x200, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    float32 m_flRadiusScale; // offset 0x1F8, size 0x4, align 4 | MPropertyFriendlyName
