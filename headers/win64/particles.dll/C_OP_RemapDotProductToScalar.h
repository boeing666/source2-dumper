...
class C_OP_RemapDotProductToScalar : public CParticleFunctionOperator /*0x0*/  // sizeof 0x208, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    bool m_bUseParticleVelocity; // offset 0x1FC, size 0x1, align 1 | MPropertyFriendlyName
    char _pad_01FD[0x3]; // offset 0x1FD
    ParticleSetMethod_t m_nSetMethod; // offset 0x200, size 0x4, align 4 | MPropertyFriendlyName
    bool m_bActiveRange; // offset 0x204, size 0x1, align 1 | MPropertyFriendlyName
    bool m_bUseParticleNormal; // offset 0x205, size 0x1, align 1 | MPropertyFriendlyName
