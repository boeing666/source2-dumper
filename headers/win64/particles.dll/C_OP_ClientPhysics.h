...
class C_OP_ClientPhysics : public CParticleFunctionRenderer /*0x0*/  // sizeof 0x540, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    ParticleAttributeIndex_t m_nNoCollisionAttribute; // offset 0x534, size 0x4, align 255 | MPropertyFriendlyName MPropertyAttributeChoiceName MPropertySuppressExpr
    ParticleAttributeIndex_t m_nZeroGravityAttribute; // offset 0x538, size 0x4, align 255 | MPropertyFriendlyName MPropertyAttributeChoiceName MPropertySuppressExpr
