...
class C_OP_RenderSprites : public CBaseRendererSource2 /*0x0*/  // sizeof 0x5248, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults MGPUParticleFunction}
{
public:
    ...
    CParticleCollectionRendererFloatInput m_flSubPixelAAScale; // offset 0x3250, size 0x170, align 8 | MPropertyFriendlyName MPropertySuppressExpr MPropertySortPriority
