...
class C_INIT_CreateOnModel : public CParticleFunctionInitializer /*0x0*/  // sizeof 0x1398, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults MGPUParticleFunction}
{
public:
    ...
    int32 m_nForceInModel; // offset 0x2A8, size 0x4, align 4 | MPropertyFriendlyName MPropertySuppressExpr
    ...
    CParticleCollectionVecInput m_vecDirectionBias; // offset 0xAE8, size 0x6B8, align 8 | MPropertyFriendlyName MVectorIsCoordinate MPropertySuppressExpr
    ...
    bool m_bUseBones; // offset 0x1221, size 0x1, align 1 | MPropertyFriendlyName MPropertySuppressExpr
    bool m_bUseMesh; // offset 0x1222, size 0x1, align 1 | MPropertyFriendlyName MPropertySuppressExpr
    char _pad_1223[0x5]; // offset 0x1223
    CParticleCollectionFloatInput m_flShellSize; // offset 0x1228, size 0x170, align 8 | MPropertyFriendlyName MPropertySuppressExpr
};
