...
class C_INIT_PositionPlaceOnGround : public CParticleFunctionInitializer /*0x0*/  // sizeof 0xC30, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults MGPUParticleFunction}
{
public:
    ...
    char[128] m_CollisionGroupName; // offset 0xB78, size 0x80, align 1 | MPropertyFriendlyName MPropertySuppressExpr
    ...
    bool m_bOffsetonColOnly; // offset 0xC1C, size 0x1, align 1 | MPropertyFriendlyName MPropertySuppressExpr
    char _pad_0C1D[0x3]; // offset 0xC1D
    float32 m_flOffsetByRadiusFactor; // offset 0xC20, size 0x4, align 4 | MPropertyFriendlyName MPropertySuppressExpr
    int32 m_nPreserveOffsetCP; // offset 0xC24, size 0x4, align 4 | MPropertyFriendlyName MPropertySuppressExpr
