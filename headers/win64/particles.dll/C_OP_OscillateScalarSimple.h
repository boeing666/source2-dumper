...
class C_OP_OscillateScalarSimple : public CParticleFunctionOperator /*0x0*/  // sizeof 0x220, align 0x10 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    char _pad_0000[0x1E0]; // offset 0x0
    float32 m_Rate; // offset 0x1E0, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_Frequency; // offset 0x1E4, size 0x4, align 4 | MPropertyFriendlyName
