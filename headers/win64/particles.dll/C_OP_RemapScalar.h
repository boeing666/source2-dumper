...
class C_OP_RemapScalar : public CParticleFunctionOperator /*0x0*/  // sizeof 0x200, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    bool m_bOldCode; // offset 0x1F8, size 0x1, align 1 | MPropertyFriendlyName
