...
class C_OP_RemapCPtoVector : public CParticleFunctionOperator /*0x0*/  // sizeof 0x230, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    float32 m_flStartTime; // offset 0x21C, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_flEndTime; // offset 0x220, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_flInterpRate; // offset 0x224, size 0x4, align 4 | MPropertyFriendlyName
    ParticleSetMethod_t m_nSetMethod; // offset 0x228, size 0x4, align 4 | MPropertyFriendlyName
    bool m_bOffset; // offset 0x22C, size 0x1, align 1 | MPropertyFriendlyName
    bool m_bAccelerate; // offset 0x22D, size 0x1, align 1 | MPropertyFriendlyName
