...
class C_OP_DifferencePreviousParticle : public CParticleFunctionOperator /*0x0*/  // sizeof 0x1F8, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    bool m_bSetPreviousParticle; // offset 0x1F5, size 0x1, align 1 | MPropertyFriendlyName
