...
class C_OP_PositionLock : public CParticleFunctionOperator /*0x0*/  // sizeof 0xAA0, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    float32 m_flStartTime_exp; // offset 0x248, size 0x4, align 4 | MPropertyFriendlyName
    ...
    float32 m_flEndTime_exp; // offset 0x254, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_flRange; // offset 0x258, size 0x4, align 4 | MPropertyFriendlyName
    char _pad_025C[0x4]; // offset 0x25C
    CParticleCollectionFloatInput m_flRangeBias; // offset 0x260, size 0x170, align 8 | MPropertyFriendlyName
    float32 m_flJumpThreshold; // offset 0x3D0, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_flPrevPosScale; // offset 0x3D4, size 0x4, align 4 | MPropertyFriendlyName
