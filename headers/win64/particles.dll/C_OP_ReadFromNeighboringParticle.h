...
class C_OP_ReadFromNeighboringParticle : public CParticleFunctionOperator /*0x0*/  // sizeof 0x4C8, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    CPerParticleFloatInput m_DistanceCheck; // offset 0x1E8, size 0x170, align 8 | MPropertyFriendlyName
    CPerParticleFloatInput m_flInterpolation; // offset 0x358, size 0x170, align 8 | MPropertyFriendlyName
};
