...
class C_INIT_CreationNoise : public CParticleFunctionInitializer /*0x0*/  // sizeof 0x218, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    float32 m_flNoiseScaleLoc; // offset 0x200, size 0x4, align 4 | MPropertyFriendlyName
