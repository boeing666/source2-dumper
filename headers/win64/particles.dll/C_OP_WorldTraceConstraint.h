...
class C_OP_WorldTraceConstraint : public CParticleFunctionConstraint /*0x0*/  // sizeof 0x9D8, align 0x8 [vtable] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    bool m_bSetNormal; // offset 0x858, size 0x1, align 1 | MPropertyFriendlyName
