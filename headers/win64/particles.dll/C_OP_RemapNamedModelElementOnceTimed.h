...
class C_OP_RemapNamedModelElementOnceTimed : public CParticleFunctionOperator /*0x0*/  // sizeof 0x238, align 0xFF [vtable abstract] (particles) {MGetKV3ClassDefaults}
{
public:
    ...
    bool m_bProportional; // offset 0x229, size 0x1, align 1 | MPropertyFriendlyName
    ...
    float32 m_flRemapTime; // offset 0x234, size 0x4, align 4 | MPropertyFriendlyName
};
