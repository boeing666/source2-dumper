...
class CVsndRadioButtonSlot  // sizeof 0x88, align 0x8 (soundsystem_voicecontainers) {MGetKV3ClassDefaults}
{
public:
    ...
    int32 m_group; // offset 0x78, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_volume; // offset 0x7C, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_fadeOut; // offset 0x80, size 0x4, align 4 | MPropertyFriendlyName
    EVsndPlaybackMode m_mode; // offset 0x84, size 0x4, align 4 | MPropertyFriendlyName
};
