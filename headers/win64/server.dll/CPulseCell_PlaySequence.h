...
class CPulseCell_PlaySequence : public CPulseCell_BaseYieldingInflow /*0x0*/  // sizeof 0xF8, align 0x8 [vtable] (server) {MGetKV3ClassDefaults MPropertyFriendlyName MPropertyDescription}
{
public:
