...
public:
    ...
    CFuncRotator::Rotate_t m_eRotateType; // offset 0x770, size 0x4, align 4
    bool m_bIsRotating; // offset 0x774, size 0x1, align 1
    SolidType_t m_eSolidType; // offset 0x775, size 0x1, align 1
    char _pad_0776[0x2]; // offset 0x776
    float32 m_flSpeed; // offset 0x778, size 0x4, align 4
    float32 m_flTimeToCompleteRotation; // offset 0x77C, size 0x4, align 4
    CHandle< CBaseEntity > m_hRotatorTarget; // offset 0x780, size 0x4, align 4
    char _pad_0784[0x4]; // offset 0x784
    CUtlSymbolLarge m_strRotatorTarget; // offset 0x788, size 0x8, align 8
    CUtlVector< Quaternion > m_vecLocalRotationHistory; // offset 0x790, size 0x18, align 8
    CEntityIOOutput m_OnRotationStarted; // offset 0x7A8, size 0x18, align 255
    CEntityIOOutput m_OnRotationCompleted; // offset 0x7C0, size 0x18, align 255
    CEntityIOOutput m_OnOscillate; // offset 0x7D8, size 0x18, align 255
    CEntityIOOutput m_OnOscillateStartArrive; // offset 0x7F0, size 0x18, align 255
    CEntityIOOutput m_OnOscillateStartDepart; // offset 0x808, size 0x18, align 255
    CEntityIOOutput m_OnOscillateEndArrive; // offset 0x820, size 0x18, align 255
    CEntityIOOutput m_OnOscillateEndDepart; // offset 0x838, size 0x18, align 255
    GameTick_t m_nTickRotateRan; // offset 0x850, size 0x4, align 255
    bool m_bStartedRotating; // offset 0x854, size 0x1, align 1
    char _pad_0855[0x3]; // offset 0x855
    FuncRotatorRotationSummary_t m_rotationSummary; // offset 0x858, size 0x8, align 4
    float32 m_flTimeToReachMaxSpeed; // offset 0x860, size 0x4, align 4
    float32 m_flTimeToReachZeroSpeed; // offset 0x864, size 0x4, align 4
    GameTime_t m_flTimeRotationStart; // offset 0x868, size 0x4, align 255
    GameTime_t m_flTimeRotationStop; // offset 0x86C, size 0x4, align 255
    float32 m_flStartSpeed; // offset 0x870, size 0x4, align 4
