...
class CDOTA_Modifier_Phoenix_IcarusYoink : public CDOTA_Buff /*0x0*/  // sizeof 0x1AE8, align 0xFF [vtable] (server)
{
public:
    ...
    CUtlVector< CHandle< CBaseEntity > > m_vecHitEntities; // offset 0x1AC8, size 0x18, align 8
    CHandle< CBaseEntity > hTarget; // offset 0x1AE0, size 0x4, align 4
