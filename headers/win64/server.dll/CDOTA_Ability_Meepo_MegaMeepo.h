...
class CDOTA_Ability_Meepo_MegaMeepo : public CDOTABaseAbility /*0x0*/  // sizeof 0x5C0, align 0x8 [vtable] (server)
{
public:
    ...
    CUtlVector< int32 > hFlingHandles; // offset 0x5A0, size 0x18, align 8
    bool m_bHasSwappedAbilities; // offset 0x5B8, size 0x1, align 1
