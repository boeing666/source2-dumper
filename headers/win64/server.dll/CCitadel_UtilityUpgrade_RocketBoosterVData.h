...
class CCitadel_UtilityUpgrade_RocketBoosterVData : public CCitadel_UtilityUpgrade_RocketBootsVData /*0x0*/  // sizeof 0x1C98, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
