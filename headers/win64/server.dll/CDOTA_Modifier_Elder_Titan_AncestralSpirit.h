...
class CDOTA_Modifier_Elder_Titan_AncestralSpirit : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC0, align 0xFF [vtable] (server)
{
public:
    ...
    CUtlVector< CHandle< CBaseEntity > > m_hHitUnits; // offset 0x1A90, size 0x18, align 8
