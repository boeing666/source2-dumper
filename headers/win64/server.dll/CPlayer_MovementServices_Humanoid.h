...
class CPlayer_MovementServices_Humanoid : public CPlayer_MovementServices /*0x0*/  // sizeof 0x278, align 0xFF [vtable] (server) {MNetworkVarNames}
{
public:
    ...
    Vector m_vecSmoothedVelocity; // offset 0x26C, size 0xC, align 4
};
