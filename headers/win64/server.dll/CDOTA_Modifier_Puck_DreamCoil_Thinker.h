...
class CDOTA_Modifier_Puck_DreamCoil_Thinker : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC8, align 0xFF [vtable] (server)
{
public:
    char _pad_0000[0x1A78]; // offset 0x0
    CUtlVector< CHandle< CBaseEntity > > m_hLinkedEntities; // offset 0x1A78, size 0x18, align 8
