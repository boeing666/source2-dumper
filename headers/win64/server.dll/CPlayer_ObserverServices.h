...
class CPlayer_ObserverServices : public CPlayerPawnComponent /*0x0*/  // sizeof 0x58, align 0xFF [vtable] (server) {MNetworkVarNames MNetworkVarNames}
{
public:
    ...
    CHandle< CBaseEntity > m_hObserverTarget; // offset 0x4C, size 0x4, align 4 | MNetworkEnable MNetworkChangeCallback
