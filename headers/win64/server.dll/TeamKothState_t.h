...
struct TeamKothState_t  // sizeof 0x58, align 0xFF [vtable] (server) {MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames}
{
    ...
    CNetworkUtlVectorBase< HeroID_t > m_vecParticipants; // offset 0x40, size 0x18, align 8 | MNetworkEnable
};
