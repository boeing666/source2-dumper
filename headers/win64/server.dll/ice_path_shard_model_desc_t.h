...
struct ice_path_shard_model_desc_t  // sizeof 0x38, align 0xFF [vtable] (server) {MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames}
{
    ...
    CNetworkUtlVectorBase< Vector > m_vecPanelVertices; // offset 0x18, size 0x18, align 8 | MNetworkEnable
