...
class CDOTA_Ability_Creature_Ice_Breath : public CDOTABaseAbility /*0x0*/  // sizeof 0x5C8, align 0x8 [vtable] (server)
{
public:
    ...
    float32 slow_duration; // offset 0x594, size 0x4, align 4
