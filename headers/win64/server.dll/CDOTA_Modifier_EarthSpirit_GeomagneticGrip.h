...
class CDOTA_Modifier_EarthSpirit_GeomagneticGrip : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC8, align 0xFF [vtable] (server)
{
public:
    ...
    CUtlVector< CHandle< CBaseEntity > > m_hHitEntities; // offset 0x1AB0, size 0x18, align 8
};
