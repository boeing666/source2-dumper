...
class CCitadel_Modifier_DPSTracker : public CCitadelModifier /*0x0*/  // sizeof 0xF8, align 0xFF [vtable] (server)
{
public:
    ...
    float32 m_flDistToTarget; // offset 0xF0, size 0x4, align 4
