...
class CGradientFog : public CBaseEntity /*0x0*/  // sizeof 0x4E8, align 0x8 [vtable] (server) {MEntityAllowsPortraitWorldSpawn}
{
public:
    ...
    Color m_fogColor; // offset 0x4D4, size 0x4, align 4
