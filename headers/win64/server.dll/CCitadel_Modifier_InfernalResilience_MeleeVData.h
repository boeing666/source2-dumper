...
class CCitadel_Modifier_InfernalResilience_MeleeVData : public CCitadel_Modifier_BaseEventProcVData /*0x0*/  // sizeof 0x950, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
