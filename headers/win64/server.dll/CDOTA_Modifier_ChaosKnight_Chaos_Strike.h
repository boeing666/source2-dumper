...
class CDOTA_Modifier_ChaosKnight_Chaos_Strike : public CDOTA_Buff /*0x0*/  // sizeof 0x1AA8, align 0xFF [vtable] (server)
{
public:
    ...
    CUtlVector< AttackRecord_t > m_vCritRecords; // offset 0x1A90, size 0x18, align 8
};
