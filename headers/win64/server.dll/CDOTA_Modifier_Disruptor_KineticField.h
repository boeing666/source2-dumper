...
class CDOTA_Modifier_Disruptor_KineticField : public CDOTA_Buff /*0x0*/  // sizeof 0x1AB8, align 0xFF [vtable] (server)
{
public:
    ...
    char _pad_1AB0[0x4]; // offset 0x1AB0
    bool is_wall; // offset 0x1AB4, size 0x1, align 1
