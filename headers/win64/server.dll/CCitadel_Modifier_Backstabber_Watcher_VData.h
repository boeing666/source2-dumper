...
class CCitadel_Modifier_Backstabber_Watcher_VData : public CCitadel_Modifier_Intrinsic_BaseVData /*0x0*/  // sizeof 0x778, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
