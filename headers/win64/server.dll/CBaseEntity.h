...
class CBaseEntity : public CEntityInstance /*0x0*/  // sizeof 0x4A8, align 0x8 [vtable] (server)
{
public:
    ...
    Vector m_vecBaseVelocity; // offset 0x3C8, size 0xC, align 4
    int32 m_nPushEnumCount; // offset 0x3D4, size 0x4, align 4 | MNotSaved
    CCollisionProperty* m_pCollision; // offset 0x3D8, size 0x8, align 8 | MNotSaved
    CHandle< CBaseEntity > m_hEffectEntity; // offset 0x3E0, size 0x4, align 4
    CHandle< CBaseEntity > m_hOwnerEntity; // offset 0x3E4, size 0x4, align 4
    uint32 m_fEffects; // offset 0x3E8, size 0x4, align 4
    CHandle< CBaseEntity > m_hGroundEntity; // offset 0x3EC, size 0x4, align 4
    int32 m_nGroundBodyIndex; // offset 0x3F0, size 0x4, align 4
    float32 m_flFriction; // offset 0x3F4, size 0x4, align 4
    float32 m_flElasticity; // offset 0x3F8, size 0x4, align 4
    float32 m_flGravityScale; // offset 0x3FC, size 0x4, align 4
    float32 m_flTimeScale; // offset 0x400, size 0x4, align 4
    float32 m_flWaterLevel; // offset 0x404, size 0x4, align 4
    bool m_bGravityDisabled; // offset 0x408, size 0x1, align 1
    bool m_bAnimatedEveryTick; // offset 0x409, size 0x1, align 1
    char _pad_040A[0x2]; // offset 0x40A
    float32 m_flActualGravityScale; // offset 0x40C, size 0x4, align 4
    bool m_bGravityActuallyDisabled; // offset 0x410, size 0x1, align 1
    bool m_bDisableLowViolence; // offset 0x411, size 0x1, align 1
    uint8 m_nWaterType; // offset 0x412, size 0x1, align 1
    char _pad_0413[0x1]; // offset 0x413
    int32 m_iEFlags; // offset 0x414, size 0x4, align 4
    CEntityIOOutput m_OnUser1; // offset 0x418, size 0x18, align 255
    CEntityIOOutput m_OnUser2; // offset 0x430, size 0x18, align 255
    CEntityIOOutput m_OnUser3; // offset 0x448, size 0x18, align 255
    CEntityIOOutput m_OnUser4; // offset 0x460, size 0x18, align 255
    int32 m_iInitialTeamNum; // offset 0x478, size 0x4, align 4
    GameTime_t m_flNavIgnoreUntilTime; // offset 0x47C, size 0x4, align 255
    QAngle m_vecAngVelocity; // offset 0x480, size 0xC, align 4
    bool m_bNetworkQuantizeOriginAndAngles; // offset 0x48C, size 0x1, align 1
    bool m_bLagCompensate; // offset 0x48D, size 0x1, align 1
    char _pad_048E[0x2]; // offset 0x48E
    CHandle< CBaseEntity > m_pBlocker; // offset 0x490, size 0x4, align 4
    float32 m_flLocalTime; // offset 0x494, size 0x4, align 4
    float32 m_flVPhysicsUpdateLocalTime; // offset 0x498, size 0x4, align 4
    BloodType m_nBloodType; // offset 0x49C, size 0x4, align 4
    CPulseGraphInstance_ServerEntity* m_pPulseGraphInstance; // offset 0x4A0, size 0x8, align 8 | MKV3TransferSaveOpsForField
};
