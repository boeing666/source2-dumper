...
class CAbilityCrackshotVData : public CitadelAbilityVData /*0x0*/  // sizeof 0x1B18, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
    ...
    CEmbeddedSubclass< CCitadelModifier > m_BulletResistModifier; // offset 0x1AD8, size 0x10, align 8
    CSoundEventName m_HeadShotVictimSound; // offset 0x1AE8, size 0x10, align 8 | MPropertyStartGroup
    CSoundEventName m_HeadShotConfirmationSound; // offset 0x1AF8, size 0x10, align 8
    CSoundEventName m_ReadySound; // offset 0x1B08, size 0x10, align 8
};
