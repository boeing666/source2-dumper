...
class CCSPlayer_MovementServices : public CPlayer_MovementServices_Humanoid /*0x0*/  // sizeof 0xFE0, align 0xFF [vtable] (server)
{
public:
    ...
    bool m_bMadeFootstepNoise; // offset 0x684, size 0x1, align 1
    char _pad_0685[0x3]; // offset 0x685
    int32 m_iFootsteps; // offset 0x688, size 0x4, align 4
    GameTime_t m_fStashGrenadeParameterWhen; // offset 0x68C, size 0x4, align 255
    bool m_bUseFrictionStashedSpeed; // offset 0x690, size 0x1, align 1
    char _pad_0691[0x3]; // offset 0x691
    float32 m_flUseFrictionStashedSpeedUntilFrac; // offset 0x694, size 0x4, align 4
    float32 m_flFrictionStashedSpeed; // offset 0x698, size 0x4, align 4
    float32 m_flStamina; // offset 0x69C, size 0x4, align 4
    float32 m_flHeightAtJumpStart; // offset 0x6A0, size 0x4, align 4
    float32 m_flMaxJumpHeightThisJump; // offset 0x6A4, size 0x4, align 4
    float32 m_flMaxJumpHeightLastJump; // offset 0x6A8, size 0x4, align 4
    float32 m_flStaminaAtJumpStart; // offset 0x6AC, size 0x4, align 4
    float32 m_flVelMulAtJumpStart; // offset 0x6B0, size 0x4, align 4
    float32 m_flAccumulatedJumpError; // offset 0x6B4, size 0x4, align 4
    CCSPlayerLegacyJump m_LegacyJump; // offset 0x6B8, size 0x18, align 255
    CCSPlayerModernJump m_ModernJump; // offset 0x6D0, size 0x38, align 255
    GameTick_t m_nLastJumpTick; // offset 0x708, size 0x4, align 255
    float32 m_flLastJumpFrac; // offset 0x70C, size 0x4, align 4
    float32 m_flLastJumpVelocityZ; // offset 0x710, size 0x4, align 4
    bool m_bJumpApexPending; // offset 0x714, size 0x1, align 1
    char _pad_0715[0x3]; // offset 0x715
    float32 m_flTicksSinceLastSurfingDetected; // offset 0x718, size 0x4, align 4
    char _pad_071C[0x8C]; // offset 0x71C
    Vector2D m_vecWalkWishVel; // offset 0x7A8, size 0x8, align 4
    char _pad_07B0[0x820]; // offset 0x7B0
