...
class CCitadel_Ability_Doorman_Doorway : public CCitadelBaseAbility /*0x0*/  // sizeof 0x1138, align 0x8 [vtable] (server) {MNetworkVarNames}
{
public:
    ...
    char _pad_0FB0[0x180]; // offset 0xFB0
    float32 m_flDoorBreakableRadius; // offset 0x1130, size 0x4, align 4
