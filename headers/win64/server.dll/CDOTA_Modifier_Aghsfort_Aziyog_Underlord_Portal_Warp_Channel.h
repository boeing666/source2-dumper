...
class CDOTA_Modifier_Aghsfort_Aziyog_Underlord_Portal_Warp_Channel : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC0, align 0xFF [vtable] (server)
{
public:
    ...
    VectorWS m_vStartPosition; // offset 0x1AA4, size 0xC, align 4
    float32 m_flTotalTime; // offset 0x1AB0, size 0x4, align 4
    float32 m_flElapsedTimePortion; // offset 0x1AB4, size 0x4, align 4
    float32 animation_rate; // offset 0x1AB8, size 0x4, align 4
    int32 stop_distance; // offset 0x1ABC, size 0x4, align 4
};
