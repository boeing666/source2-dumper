...
class CDOTA_Modifier_MonkeyKing_Transform : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC0, align 0xFF [vtable] (server)
{
public:
    ...
    CHandle< CBaseEntity > m_hCourierToClone; // offset 0x1A90, size 0x4, align 4
    CHandle< CBaseEntity > m_hCreepToClone; // offset 0x1A94, size 0x4, align 4
    CUtlVector< CHandle< CBaseEntity > > m_aryBountyRuneSpawners; // offset 0x1A98, size 0x18, align 8
