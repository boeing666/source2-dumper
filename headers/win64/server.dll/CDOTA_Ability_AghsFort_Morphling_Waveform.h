...
class CDOTA_Ability_AghsFort_Morphling_Waveform : public CDOTABaseAbility /*0x0*/, public CHorizontalMotionController /*0x580*/  // sizeof 0x5B0, align 0x8 [vtable] (server)
{
public:
