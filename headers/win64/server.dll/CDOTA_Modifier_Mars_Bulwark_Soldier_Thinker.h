...
class CDOTA_Modifier_Mars_Bulwark_Soldier_Thinker : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC0, align 0xFF [vtable] (server)
{
public:
    ...
    CUtlVector< CHandle< CBaseEntity > > m_hAllSoldiers; // offset 0x1A90, size 0x18, align 8
