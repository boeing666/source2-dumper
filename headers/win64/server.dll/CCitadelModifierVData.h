...
class CCitadelModifierVData : public CModifierVData /*0x0*/  // sizeof 0x750, align 0x8 [vtable] (server) {MGetKV3ClassDefaults MPropertySuppressBaseClassField MPropertySuppressBaseClassField}
{
public:
