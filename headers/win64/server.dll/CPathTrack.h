...
public:
    ...
    CPathTrack* m_pnext; // offset 0x4A0, size 0x8, align 8 | MClassPtr
    CPathTrack* m_pprevious; // offset 0x4A8, size 0x8, align 8 | MClassPtr
    CPathTrack* m_paltpath; // offset 0x4B0, size 0x8, align 8 | MClassPtr
