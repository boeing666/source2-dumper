...
class CDOTA_Modifier_Weaver_Swarm_Debuff : public CDOTA_Buff /*0x0*/  // sizeof 0x1A90, align 0xFF [vtable] (server)
{
public:
    ...
    CHandle< CBaseEntity > m_hSwarmBug; // offset 0x1A88, size 0x4, align 4
