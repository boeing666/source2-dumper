...
class CAI_CitadelNPCVData : public CAI_BaseNPCVData /*0x0*/  // sizeof 0x1348, align 0x8 [vtable] (server) {MGetKV3ClassDefaults MPropertySuppressBaseClassField MPropertySuppressBaseClassField MPropertySuppressBaseClassField MPropertySuppressBaseClassField MPropertySuppressBaseClassField MPropertySuppressBaseClassField}
{
public:
