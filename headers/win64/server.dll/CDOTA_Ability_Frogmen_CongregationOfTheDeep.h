...
class CDOTA_Ability_Frogmen_CongregationOfTheDeep : public CDOTABaseAbility /*0x0*/  // sizeof 0x5C8, align 0x8 [vtable] (server)
{
public:
    ...
    int32 projectile_count; // offset 0x5A8, size 0x4, align 4
    int32 projectile_width; // offset 0x5AC, size 0x4, align 4
    float32 neutral_shared_cooldown; // offset 0x5B0, size 0x4, align 4
