...
class CDOTA_Modifier_MonkeyKing_FurArmyThinker : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC8, align 0xFF [vtable] (server)
{
public:
    ...
    GameTime_t m_flLastTimeInsideRing; // offset 0x1AC0, size 0x4, align 255
