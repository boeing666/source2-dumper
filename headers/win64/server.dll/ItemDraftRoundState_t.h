...
struct ItemDraftRoundState_t  // sizeof 0x88, align 0xFF [vtable] (server) {MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames}
{
    char _pad_0000[0x8]; // offset 0x0
    CUtlVectorEmbeddedNetworkVar< ItemDraftOption_t > m_vecOptions; // offset 0x8, size 0x68, align 8 | MNetworkEnable
