...
struct audioparams_t  // sizeof 0x78, align 0xFF [vtable trivial_dtor] (server) {MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames}
{
