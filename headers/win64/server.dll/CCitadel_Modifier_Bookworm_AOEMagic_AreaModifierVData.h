...
class CCitadel_Modifier_Bookworm_AOEMagic_AreaModifierVData : public CCitadelModifierVData /*0x0*/  // sizeof 0xA30, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
