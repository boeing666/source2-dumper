...
struct DynamicVolumeDef_t  // sizeof 0x30, align 0xFF [trivial_dtor] (server)
{
    ...
    Vector m_vSourceAnchorPos; // offset 0xC, size 0xC, align 4
    Vector m_vTargetAnchorPos; // offset 0x18, size 0xC, align 4
