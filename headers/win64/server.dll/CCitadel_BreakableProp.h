...
class CCitadel_BreakableProp : public CBaseAnimGraph /*0x0*/  // sizeof 0xAB0, align 0x10 [vtable] (server) {MNetworkIncludeByName MNetworkIncludeByName MNetworkIncludeByName MNetworkVarNames}
{
public:
