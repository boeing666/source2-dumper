...
class CCitadel_Modifier_Werewolf_UnloadGun2VData : public CCitadel_Modifier_BaseBulletPreRollProcVData /*0x0*/  // sizeof 0x980, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
