...
class CCitadel_Modifier_RebuttalWatcherVData : public CCitadel_Modifier_Intrinsic_BaseVData /*0x0*/  // sizeof 0x790, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
