...
public:
    ...
    char _pad_0050[0x176]; // offset 0x50
    bool m_bModifierStatesDirty; // offset 0x1C6, size 0x1, align 1 | MNotSaved
    bool m_bPredictedOwner; // offset 0x1C7, size 0x1, align 1 | MNotSaved
    bool m_bAllowModifiersOnDeadEntities; // offset 0x1C8, size 0x1, align 1 | MNetworkEnable
    int8 m_iLockRefCount; // offset 0x1C9, size 0x1, align 1 | MNotSaved
