...
public:
    ...
    char _pad_0050[0x177]; // offset 0x50
    bool m_bModifierStatesDirty; // offset 0x1C7, size 0x1, align 1 | MNotSaved
    bool m_bPredictedOwner; // offset 0x1C8, size 0x1, align 1 | MNotSaved
    bool m_bAllowModifiersOnDeadEntities; // offset 0x1C9, size 0x1, align 1 | MNetworkEnable
    int8 m_iLockRefCount; // offset 0x1CA, size 0x1, align 1 | MNotSaved
    char _pad_01CB[0x1]; // offset 0x1CB
    ModifierPropRuntimeHandle_t m_hHandle; // offset 0x1CC, size 0x2, align 255 | MNotSaved
    char _pad_01CE[0x2]; // offset 0x1CE
    uint32 m_nBroadcastEventListenerMask; // offset 0x1D0, size 0x4, align 4 | MNotSaved
    ParticleIndex_t m_nCachedHighestParticleIndex; // offset 0x1D4, size 0x4, align 255 | MNotSaved
