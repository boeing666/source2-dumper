...
class CCitadel_Modifier_AfterburnWatcherVData : public CCitadel_Modifier_BaseEventProcVData /*0x0*/  // sizeof 0x7C0, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
