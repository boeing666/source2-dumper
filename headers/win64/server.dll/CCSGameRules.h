...
class CCSGameRules : public CTeamplayRules /*0x0*/  // sizeof 0x11448, align 0xFF [vtable] (server)
{
public:
    ...
    char _pad_10B0[0x88]; // offset 0x10B0
    CHandle< CBaseEntity > m_hPlayerResource; // offset 0x1138, size 0x4, align 4
    char _pad_113C[0x4]; // offset 0x113C
    CRetakeGameRules m_RetakeRules; // offset 0x1140, size 0x1F0, align 255
    CUtlVector< int32 >[4] m_arrTeamUniqueKillWeaponsMatch; // offset 0x1330, size 0x60, align 8
    bool[4] m_bTeamLastKillUsedUniqueWeaponMatch; // offset 0x1390, size 0x4, align 1
    char _pad_1394[0x24]; // offset 0x1394
    uint8 m_nMatchEndCount; // offset 0x13B8, size 0x1, align 1
    char _pad_13B9[0x3]; // offset 0x13B9
    int32 m_nTTeamIntroVariant; // offset 0x13BC, size 0x4, align 4
    int32 m_nCTTeamIntroVariant; // offset 0x13C0, size 0x4, align 4
    bool m_bTeamIntroPeriod; // offset 0x13C4, size 0x1, align 1
    char _pad_13C5[0x3]; // offset 0x13C5
    GameTime_t m_fTeamIntroPeriodEnd; // offset 0x13C8, size 0x4, align 255
    bool m_bPlayedTeamIntroVO; // offset 0x13CC, size 0x1, align 1
    char _pad_13CD[0x3]; // offset 0x13CD
    int32 m_iRoundEndWinnerTeam; // offset 0x13D0, size 0x4, align 4
    int32 m_eRoundEndReason; // offset 0x13D4, size 0x4, align 4
    bool m_bRoundEndShowTimerDefend; // offset 0x13D8, size 0x1, align 1
    char _pad_13D9[0x3]; // offset 0x13D9
    int32 m_iRoundEndTimerTime; // offset 0x13DC, size 0x4, align 4
    CUtlString m_sRoundEndFunFactToken; // offset 0x13E0, size 0x8, align 8
    CPlayerSlot m_iRoundEndFunFactPlayerSlot; // offset 0x13E8, size 0x4, align 4
    int32 m_iRoundEndFunFactData1; // offset 0x13EC, size 0x4, align 4
    int32 m_iRoundEndFunFactData2; // offset 0x13F0, size 0x4, align 4
    int32 m_iRoundEndFunFactData3; // offset 0x13F4, size 0x4, align 4
    CUtlString m_sRoundEndMessage; // offset 0x13F8, size 0x8, align 8
    int32 m_iRoundEndPlayerCount; // offset 0x1400, size 0x4, align 4
    bool m_bRoundEndNoMusic; // offset 0x1404, size 0x1, align 1
    char _pad_1405[0x3]; // offset 0x1405
    int32 m_iRoundEndLegacy; // offset 0x1408, size 0x4, align 4
    uint8 m_nRoundEndCount; // offset 0x140C, size 0x1, align 1
    char _pad_140D[0x3]; // offset 0x140D
    int32 m_iRoundStartRoundNumber; // offset 0x1410, size 0x4, align 4
    uint8 m_nRoundStartCount; // offset 0x1414, size 0x1, align 1
    char _pad_1415[0x400B]; // offset 0x1415
    float64 m_flLastPerfSampleTime; // offset 0x5420, size 0x8, align 8
    char _pad_5428[0xC020]; // offset 0x5428
};
