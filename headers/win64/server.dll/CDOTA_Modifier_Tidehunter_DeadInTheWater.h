...
class CDOTA_Modifier_Tidehunter_DeadInTheWater : public CDOTA_Buff /*0x0*/  // sizeof 0x1A88, align 0xFF [vtable] (server)
{
public:
    char _pad_0000[0x1A78]; // offset 0x0
    int32 max_movement_speed; // offset 0x1A78, size 0x4, align 4
    int32 chain_length; // offset 0x1A7C, size 0x4, align 4
    CHandle< CBaseEntity > m_hAnchor; // offset 0x1A80, size 0x4, align 4
