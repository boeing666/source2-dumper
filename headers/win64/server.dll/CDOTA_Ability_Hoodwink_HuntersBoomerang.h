...
class CDOTA_Ability_Hoodwink_HuntersBoomerang : public CDOTABaseAbility /*0x0*/  // sizeof 0x5C8, align 0x8 [vtable] (server)
{
public:
    ...
    float32 mark_duration; // offset 0x58C, size 0x4, align 4
