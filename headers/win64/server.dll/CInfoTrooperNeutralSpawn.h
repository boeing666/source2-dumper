...
class CInfoTrooperNeutralSpawn : public CServerOnlyPointEntity /*0x0*/  // sizeof 0x4C0, align 0x8 [vtable] (server)
{
public:
    ...
    ENeutralTrooperType m_eTrooperType; // offset 0x4B8, size 0x4, align 4
