...
struct LockonTarget_t  // sizeof 0x50, align 0xFF [vtable] (server) {MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames}
{
    ...
    CHandle< CBaseEntity > m_hTarget; // offset 0x4C, size 0x4, align 4 | MNetworkEnable
};
