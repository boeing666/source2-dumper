...
struct PlayerResourcePlayerEventData_t  // sizeof 0x100, align 0xFF [vtable] (server)
{
    ...
    CUtlVectorEmbeddedNetworkVar< PlayerResourcePlayerPeriodicResourceData_t > m_vecPeriodicResources; // offset 0x70, size 0x68, align 8
