...
public:
    ...
    Vector m_Origin; // offset 0x4A0, size 0xC, align 4
    QAngle m_Angles; // offset 0x4AC, size 0xC, align 4
    ...
    CPathKeyFrame* m_pNextKey; // offset 0x4E0, size 0x8, align 8 | MClassPtr
    CPathKeyFrame* m_pPrevKey; // offset 0x4E8, size 0x8, align 8 | MClassPtr
    float32 m_flMoveSpeed; // offset 0x4F0, size 0x4, align 4
