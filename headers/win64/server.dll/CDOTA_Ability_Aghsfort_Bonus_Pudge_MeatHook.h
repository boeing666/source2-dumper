...
class CDOTA_Ability_Aghsfort_Bonus_Pudge_MeatHook : public CDOTABaseAbility /*0x0*/, public CHorizontalMotionController /*0x580*/  // sizeof 0x5E8, align 0x8 [vtable] (server)
{
public:
    ...
    int32 m_nNextConsecutiveHitCount; // offset 0x5DC, size 0x4, align 4
    int32 m_nConsecutiveHits; // offset 0x5E0, size 0x4, align 4
