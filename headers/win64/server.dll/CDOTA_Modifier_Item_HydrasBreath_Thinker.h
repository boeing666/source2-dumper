...
class CDOTA_Modifier_Item_HydrasBreath_Thinker : public CDOTA_Buff /*0x0*/  // sizeof 0x1A90, align 0xFF [vtable] (server)
{
public:
    ...
    bool m_bAttackLanded; // offset 0x1A89, size 0x1, align 1
