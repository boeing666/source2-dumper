...
class CDOTA_Modifier_PrimalBeast_Onslaught_Knockback : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC0, align 0xFF [vtable] (server)
{
public:
    ...
    bool m_bTargetTeleported; // offset 0x1A9D, size 0x1, align 1
