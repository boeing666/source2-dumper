...
class CDOTA_Modifier_Broodmother_StickySnare : public CDOTA_Buff /*0x0*/  // sizeof 0x1AE0, align 0xFF [vtable] (server)
{
public:
    ...
    CHandle< CBaseEntity > m_hRight; // offset 0x1AAC, size 0x4, align 4
    ...
    CUtlVector< CHandle< CBaseEntity > > m_vecAffectedHeroes; // offset 0x1AC0, size 0x18, align 8
