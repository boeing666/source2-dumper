...
struct fogplayerparams_t  // sizeof 0x40, align 0xFF [vtable trivial_dtor] (server) {MNetworkVarNames}
{
    char _pad_0000[0x8]; // offset 0x0
    CHandle< CFogController > m_hCtrl; // offset 0x8, size 0x4, align 4 | MNetworkEnable MNetworkUserGroup
