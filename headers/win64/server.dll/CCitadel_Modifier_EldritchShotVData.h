...
class CCitadel_Modifier_EldritchShotVData : public CCitadel_Modifier_BaseBulletPreRollProcVData /*0x0*/  // sizeof 0x978, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
