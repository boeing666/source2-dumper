...
class CDOTA_Modifier_SpiritBreaker_EmpoweringHaste : public CDOTA_Buff /*0x0*/  // sizeof 0x1A88, align 0xFF [vtable] (server)
{
public:
    ...
    int32 duration; // offset 0x1A84, size 0x4, align 4
};
