...
class CDOTA_Ability_Frogmen_TendrilsOfTheDeep : public CDOTABaseAbility /*0x0*/  // sizeof 0x5C8, align 0x8 [vtable] (server)
{
public:
    ...
    float32 yaw_offset; // offset 0x5A8, size 0x4, align 4
