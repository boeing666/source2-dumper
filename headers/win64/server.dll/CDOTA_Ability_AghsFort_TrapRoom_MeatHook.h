...
class CDOTA_Ability_AghsFort_TrapRoom_MeatHook : public CDOTABaseAbility /*0x0*/, public CHorizontalMotionController /*0x580*/  // sizeof 0x5E0, align 0x8 [vtable] (server)
{
public:
