...
class CDOTA_Modifier_Item_Desolator : public CDOTA_Buff_Item /*0x0*/  // sizeof 0x1AA8, align 0xFF [vtable] (server)
{
public:
    ...
    int32 max_damage; // offset 0x1A84, size 0x4, align 4
    float32 corruption_duration; // offset 0x1A88, size 0x4, align 4
