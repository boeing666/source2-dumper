...
class CDOTASpectatorGraphManager  // sizeof 0x9E0, align 0xFF [vtable] (server)
{
public:
    ...
    int32 m_event_dota_player_killed; // offset 0x9D8, size 0x4, align 4
    int32 m_event_server_pre_shutdown; // offset 0x9DC, size 0x4, align 4
};
