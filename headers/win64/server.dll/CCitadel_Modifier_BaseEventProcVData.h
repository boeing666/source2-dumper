...
class CCitadel_Modifier_BaseEventProcVData : public CCitadelModifierVData /*0x0*/  // sizeof 0x780, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
    ...
    bool m_bCanProcFromItems; // offset 0x754, size 0x1, align 1
    char _pad_0755[0x3]; // offset 0x755
    CITADEL_UNIT_TARGET_TYPE m_nAbilityTargetTypes; // offset 0x758, size 0x4, align 4
    CITADEL_UNIT_TARGET_FLAGS m_nAbilityTargetFlags; // offset 0x75C, size 0x4, align 4
