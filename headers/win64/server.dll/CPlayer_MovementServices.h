...
class CPlayer_MovementServices : public CPlayerPawnComponent /*0x0*/  // sizeof 0x240, align 0xFF [vtable] (server) {MNetworkVarNames MNetworkVarNames MNetworkVarNames}
{
public:
