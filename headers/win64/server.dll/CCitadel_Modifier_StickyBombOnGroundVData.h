...
class CCitadel_Modifier_StickyBombOnGroundVData : public CCitadel_Modifier_StickyBombAttachedVData /*0x0*/  // sizeof 0xC00, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
