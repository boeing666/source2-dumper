...
class CProjectile_GraveStone_Projectile : public CCitadelProjectile /*0x0*/  // sizeof 0x9F8, align 0x8 [vtable] (server) {MNetworkVarNames MNetworkVarNames}
{
public:
    ...
    char _pad_0878[0x180]; // offset 0x878
};
