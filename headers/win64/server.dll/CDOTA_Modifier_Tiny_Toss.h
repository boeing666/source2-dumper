...
class CDOTA_Modifier_Tiny_Toss : public CDOTA_Buff /*0x0*/  // sizeof 0x1AC8, align 0xFF [vtable] (server)
{
public:
    ...
    int32 toss_damage; // offset 0x1ABC, size 0x4, align 4
    int32 toss_land_damage_pct; // offset 0x1AC0, size 0x4, align 4
