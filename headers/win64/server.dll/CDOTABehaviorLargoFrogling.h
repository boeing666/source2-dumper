...
class CDOTABehaviorLargoFrogling : public CDOTABehaviorCompanion /*0x0*/  // sizeof 0x2F0, align 0xFF [vtable] (server)
{
public:
    ...
    bool m_bIsEmoting; // offset 0x2C0, size 0x1, align 1
    char _pad_02C1[0x3]; // offset 0x2C1
    CHandle< CDOTA_BaseNPC > m_hEmoteTarget; // offset 0x2C4, size 0x4, align 4
    CountdownTimer m_EmoteTimer; // offset 0x2C8, size 0x18, align 8
    int32 m_nEmoteActivity; // offset 0x2E0, size 0x4, align 4
    CHandle< CBaseEntity > m_tempGoalEntity; // offset 0x2E4, size 0x4, align 4
    bool m_bFollowingTempGoal; // offset 0x2E8, size 0x1, align 1
    char _pad_02E9[0x3]; // offset 0x2E9
    int32 m_event_dota_illusions_created; // offset 0x2EC, size 0x4, align 4
};
