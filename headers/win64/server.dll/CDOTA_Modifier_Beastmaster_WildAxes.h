...
class CDOTA_Modifier_Beastmaster_WildAxes : public CDOTA_Buff /*0x0*/  // sizeof 0x1B40, align 0xFF [vtable] (server)
{
public:
    ...
    CUtlVector< CHandle< CBaseEntity > > m_hAxes; // offset 0x1AB8, size 0x18, align 8
    ParticleIndex_t[2] m_nAxeFXIndex; // offset 0x1AD0, size 0x8, align 4
    CUtlVector< CHandle< CBaseEntity > >[2] m_hHitList; // offset 0x1AD8, size 0x30, align 8
    ...
    CUtlVector< CHandle< CBaseEntity > > m_vecUniqueHitList; // offset 0x1B20, size 0x18, align 8
    bool m_bHitInvisibleHero; // offset 0x1B38, size 0x1, align 1
    char _pad_1B39[0x7]; // offset 0x1B39
};
