...
class CGameRules  // sizeof 0xD0, align 0xFF [vtable abstract] (server) {MNetworkVarNames MNetworkVarNames MNetworkVarNames}
{
public:
    ...
    int32 m_nTotalPausedTicks; // offset 0xC0, size 0x4, align 4 | MNetworkEnable
    int32 m_nPauseStartTick; // offset 0xC4, size 0x4, align 4 | MNetworkEnable
    bool m_bGamePaused; // offset 0xC8, size 0x1, align 1 | MNetworkEnable
