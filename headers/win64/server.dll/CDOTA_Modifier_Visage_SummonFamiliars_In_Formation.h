...
class CDOTA_Modifier_Visage_SummonFamiliars_In_Formation : public CDOTA_Buff /*0x0*/  // sizeof 0x1AB8, align 0xFF [vtable] (server)
{
public:
    char _pad_0000[0x1A78]; // offset 0x0
    CHandle< CBaseEntity > m_hOwner; // offset 0x1A78, size 0x4, align 4
    CHandle< CBaseEntity > m_hCurrentTarget; // offset 0x1A7C, size 0x4, align 4
