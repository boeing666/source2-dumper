...
class CCitadel_Modifier_MageWalk : public CCitadelModifier /*0x0*/  // sizeof 0x408, align 0xFF [vtable] (server)
{
public:
    char _pad_0000[0xD0]; // offset 0x0
    bool m_bIsFakeout; // offset 0xD0, size 0x1, align 1
    bool m_bTeleported; // offset 0xD1, size 0x1, align 1
    ...
    char _pad_0104[0x304]; // offset 0x104
};
