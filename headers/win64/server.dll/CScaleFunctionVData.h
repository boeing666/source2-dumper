...
class CScaleFunctionVData : public CEntitySubclassVDataBase /*0x0*/  // sizeof 0x40, align 0x8 [vtable] (server) {MGetKV3ClassDefaults MVDataRoot MVDataNodeType MVDataOverlayType}
{
public:
