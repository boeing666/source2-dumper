...
class CCitadelGameRules : public CTeamplayRules /*0x0*/  // sizeof 0x2BD8, align 0xFF [vtable] (server) {MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames}
{
public:
    ...
    char _pad_1868[0x160]; // offset 0x1868
    GameTime_t m_flTimeScaleStart; // offset 0x19C8, size 0x4, align 255
    GameTime_t m_flTimeScaleEndTime; // offset 0x19CC, size 0x4, align 255
    GameTime_t m_flTimeScaleRampInEndTime; // offset 0x19D0, size 0x4, align 255
    GameTime_t m_flTimeScaleRampOutStartTime; // offset 0x19D4, size 0x4, align 255
    float32 m_flTimeScaleRampInTime; // offset 0x19D8, size 0x4, align 4
    float32 m_flTimeScaleDuration; // offset 0x19DC, size 0x4, align 4
    float32 m_flTimeScaleRampOutTime; // offset 0x19E0, size 0x4, align 4
    float32 m_flTimeScale; // offset 0x19E4, size 0x4, align 4
    float32 m_flOriginalTimeScale; // offset 0x19E8, size 0x4, align 4
    bool m_bTimeScaleActive; // offset 0x19EC, size 0x1, align 1
    char _pad_19ED[0x3]; // offset 0x19ED
    int32 m_iMidbossKillCount; // offset 0x19F0, size 0x4, align 4 | MNetworkEnable
    int32 m_iAmberRejuvCount; // offset 0x19F4, size 0x4, align 4 | MNetworkEnable
    int32 m_iSapphireRejuvCount; // offset 0x19F8, size 0x4, align 4 | MNetworkEnable
    float32 m_tNextMidBossSpawnTime; // offset 0x19FC, size 0x4, align 4 | MNetworkEnable
    char _pad_1A00[0xFC0]; // offset 0x1A00
    bool m_bServerPaused; // offset 0x29C0, size 0x1, align 1 | MNetworkEnable
    char _pad_29C1[0x3]; // offset 0x29C1
    int32 m_iPauseTeam; // offset 0x29C4, size 0x4, align 4 | MNetworkEnable
    int32 m_nMatchClockUpdateTick; // offset 0x29C8, size 0x4, align 4 | MNetworkEnable
    float32 m_flMatchClockAtLastUpdate; // offset 0x29CC, size 0x4, align 4 | MNetworkEnable
    float64 m_flPauseTime; // offset 0x29D0, size 0x8, align 8
    CPlayerSlot m_pausingPlayerId; // offset 0x29D8, size 0x4, align 4
    CPlayerSlot m_unpausingPlayerId; // offset 0x29DC, size 0x4, align 4
    float32 m_fPauseRawTime; // offset 0x29E0, size 0x4, align 4
    float32 m_fPauseCurTime; // offset 0x29E4, size 0x4, align 4
    float32 m_fUnpauseRawTime; // offset 0x29E8, size 0x4, align 4 | MNetworkEnable
    float32 m_fUnpauseCurTime; // offset 0x29EC, size 0x4, align 4
    char _pad_29F0[0x50]; // offset 0x29F0
    int32 m_nLastPreGameCount; // offset 0x2A40, size 0x4, align 4
    int32 m_eGGTeam; // offset 0x2A44, size 0x4, align 4 | MNetworkEnable
    GameTime_t m_flGGEndsAtTime; // offset 0x2A48, size 0x4, align 255 | MNetworkEnable
    char _pad_2A4C[0x4]; // offset 0x2A4C
    MatchID_t m_unMatchID; // offset 0x2A50, size 0x8, align 255 | MNetworkEnable
    CUtlString m_sGameplayExperiment; // offset 0x2A58, size 0x8, align 8 | MNetworkEnable
    uint32 m_ExperimentTokenHashCode; // offset 0x2A60, size 0x4, align 4 | MNetworkEnable
    int32 m_nPlayerDeathEventID; // offset 0x2A64, size 0x4, align 4
    int32 m_nReplayChangedEvent; // offset 0x2A68, size 0x4, align 4
    int32 m_nGameOverEvent; // offset 0x2A6C, size 0x4, align 4
    char _pad_2A70[0x20]; // offset 0x2A70
    GameTime_t m_flHeroDiedTime; // offset 0x2A90, size 0x4, align 255 | MNetworkEnable
    char _pad_2A94[0x4]; // offset 0x2A94
    CCitadelPlayOfTheGame* m_pPlayOfTheGame; // offset 0x2A98, size 0x8, align 8 | MNetworkEnable
    CStreetBrawlController m_tStreetBrawl; // offset 0x2AA0, size 0x130, align 255 | MNetworkEnable
    char _pad_2BD0[0x8]; // offset 0x2BD0
};
