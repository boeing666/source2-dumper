...
class CCitadel_Modifier_LifestrikeGauntlets_VData : public CCitadel_Modifier_BaseEventProcVData /*0x0*/  // sizeof 0x940, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
