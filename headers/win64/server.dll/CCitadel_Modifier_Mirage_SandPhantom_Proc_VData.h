...
class CCitadel_Modifier_Mirage_SandPhantom_Proc_VData : public CCitadelModifierVData /*0x0*/  // sizeof 0xA50, align 0x8 [vtable] (server) {MGetKV3ClassDefaults MPropertySuppressBaseClassField}
{
public:
