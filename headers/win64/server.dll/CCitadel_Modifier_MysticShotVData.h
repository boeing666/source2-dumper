...
class CCitadel_Modifier_MysticShotVData : public CCitadel_Modifier_BaseBulletPreRollProcVData /*0x0*/  // sizeof 0x970, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
