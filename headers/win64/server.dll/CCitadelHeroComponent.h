...
class CCitadelHeroComponent : public CEntityComponent /*0x0*/  // sizeof 0x40, align 0xFF [vtable trivial_dtor] (server) {MNetworkVarNames MNetworkVarNames MNetworkVarNames}
{
public:
