...
class CCS2WeaponGraphController : public CAnimGraphControllerBase /*0x0*/  // sizeof 0x588, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
    ...
    char _pad_0268[0x320]; // offset 0x268
};
