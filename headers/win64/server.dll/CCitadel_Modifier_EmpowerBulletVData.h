...
class CCitadel_Modifier_EmpowerBulletVData : public CCitadel_Modifier_BaseBulletPreRollProcVData /*0x0*/  // sizeof 0xB50, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
