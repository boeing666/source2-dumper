...
class CDOTA_Modifier_Jakiro_IcePath_Thinker : public CDOTA_Buff /*0x0*/  // sizeof 0x1AE0, align 0xFF [vtable] (server)
{
public:
    ...
    CUtlVector< CHandle< CBaseEntity > > m_hUnitsHit; // offset 0x1A90, size 0x18, align 8
    ...
    ParticleIndex_t m_nPathEffectIndexa; // offset 0x1AC4, size 0x4, align 255
    ParticleIndex_t m_nPathEffectIndexb; // offset 0x1AC8, size 0x4, align 255
    char _pad_1ACC[0x14]; // offset 0x1ACC
};
