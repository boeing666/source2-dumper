...
class CDOTA_Modifier_Marci_Bodyguarded : public CDOTA_Buff /*0x0*/  // sizeof 0x1AB0, align 0xFF [vtable] (server)
{
public:
    ...
    CHandle< CBaseEntity > m_hPartner; // offset 0x1AA8, size 0x4, align 4
