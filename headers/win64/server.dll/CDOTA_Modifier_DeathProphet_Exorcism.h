...
class CDOTA_Modifier_DeathProphet_Exorcism : public CDOTA_Buff /*0x0*/  // sizeof 0x1AF8, align 0xFF [vtable] (server)
{
public:
    ...
    CUtlVector< CHandle< CBaseEntity > > m_vecDeadHeroes; // offset 0x1AB0, size 0x18, align 8
