...
class CCitadel_Modifier_Mirage_SandPhantom_Passive_Victim_VData : public CCitadelModifierVData /*0x0*/  // sizeof 0xCF0, align 0x8 [vtable] (server) {MGetKV3ClassDefaults}
{
public:
