...
public:
    ...
    Vector m_vFanOriginOffset; // offset 0x8F0, size 0xC, align 4
    Vector m_vDirection; // offset 0x8FC, size 0xC, align 4
    bool m_bPushTowardsInfoTarget; // offset 0x908, size 0x1, align 1
    bool m_bPushAwayFromInfoTarget; // offset 0x909, size 0x1, align 1
