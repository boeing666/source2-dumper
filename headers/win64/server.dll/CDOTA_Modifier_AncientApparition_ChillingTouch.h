...
class CDOTA_Modifier_AncientApparition_ChillingTouch : public CDOTA_Buff /*0x0*/  // sizeof 0x1AA0, align 0xFF [vtable] (server)
{
public:
    ...
    int32 attack_range_bonus; // offset 0x1A84, size 0x4, align 4
