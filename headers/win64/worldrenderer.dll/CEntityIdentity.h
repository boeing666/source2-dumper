...
class CEntityIdentity  // sizeof 0x70, align 0xFF (entity2) {MNetworkVarNames}
{
public:
    char _pad_0000[0x14]; // offset 0x0
    int32 m_nameStringableIndex; // offset 0x14, size 0x4, align 4 | MNetworkEnable MNotSaved MNetworkChangeCallback
    ...
    CEntityAttributeTable* m_pAttributes; // offset 0x48, size 0x8, align 8 | MSaveOpsForField
