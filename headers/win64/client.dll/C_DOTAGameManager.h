...
class C_DOTAGameManager  // sizeof 0x3358, align 0xFF [vtable] (client)
{
public:
    ...
    char _pad_2D30[0x28]; // offset 0x2D30
    KeyValues* m_pCountryKeyValues; // offset 0x2D58, size 0x8, align 8
    char _pad_2D60[0x4D8]; // offset 0x2D60
    bool[9] m_bLoadedPortraits; // offset 0x3238, size 0x9, align 1
    char _pad_3241[0x7]; // offset 0x3241
    KeyValues* m_pControlGroupsKeyValues; // offset 0x3248, size 0x8, align 8
    KeyValues3* m_pItemSuggestPreferenceKeyValues; // offset 0x3250, size 0x8, align 8
    bool[256] m_CurrentHeroAvailable; // offset 0x3258, size 0x100, align 1
};
