...
class C_DOTA_Ability_PineCone_AcornShot : public C_DOTABaseAbility /*0x0*/  // sizeof 0x6C0, align 0x8 [vtable] (client)
{
public:
    ...
    int32 bounce_range; // offset 0x6B4, size 0x4, align 4
