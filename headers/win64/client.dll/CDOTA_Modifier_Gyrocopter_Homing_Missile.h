...
class CDOTA_Modifier_Gyrocopter_Homing_Missile : public CDOTA_Buff /*0x0*/  // sizeof 0x1B00, align 0xFF [vtable] (client)
{
public:
    ...
    CHandle< C_BaseEntity > m_hAttachTarget; // offset 0x1ABC, size 0x4, align 4
