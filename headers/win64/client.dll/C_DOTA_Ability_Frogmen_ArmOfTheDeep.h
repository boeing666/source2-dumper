...
class C_DOTA_Ability_Frogmen_ArmOfTheDeep : public C_DOTABaseAbility /*0x0*/  // sizeof 0x6F0, align 0x8 [vtable] (client)
{
public:
    ...
    int32 projectile_width; // offset 0x6D0, size 0x4, align 4
    float32 neutral_shared_cooldown; // offset 0x6D4, size 0x4, align 4
    char _pad_06D8[0x18]; // offset 0x6D8
};
