...
class C_GradientFog : public C_BaseEntity /*0x0*/  // sizeof 0x698, align 0x8 [vtable] (client) {MEntityAllowsPortraitWorldSpawn}
{
public:
    ...
    Color m_fogColor; // offset 0x62C, size 0x4, align 4
