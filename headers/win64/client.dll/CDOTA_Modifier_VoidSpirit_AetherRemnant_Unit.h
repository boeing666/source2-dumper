...
class CDOTA_Modifier_VoidSpirit_AetherRemnant_Unit : public CDOTA_Buff /*0x0*/  // sizeof 0x1B38, align 0xFF [vtable] (client)
{
public:
    char _pad_0000[0x1A78]; // offset 0x0
    Vector m_vFacingDir; // offset 0x1A78, size 0xC, align 4
    char _pad_1A84[0x4]; // offset 0x1A84
    CUtlVector< CHandle< C_BaseEntity > > m_hWatchPathThinkers; // offset 0x1A88, size 0x18, align 8
    CUtlVector< CHandle< C_BaseEntity > > m_hShardWatchPathThinkers; // offset 0x1AA0, size 0x18, align 8
    ...
    CUtlVector< CHandle< C_BaseEntity > > m_hAlreadyHit; // offset 0x1B08, size 0x18, align 8
    ...
    CHandle< C_BaseEntity > m_hPartnerRemnant; // offset 0x1B34, size 0x4, align 4
};
