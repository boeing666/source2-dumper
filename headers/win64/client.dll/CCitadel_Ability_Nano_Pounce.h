...
class CCitadel_Ability_Nano_Pounce : public C_CitadelBaseAbility /*0x0*/  // sizeof 0x1748, align 0x8 [vtable] (client) {MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames}
{
public:
