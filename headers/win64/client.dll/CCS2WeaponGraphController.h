...
class CCS2WeaponGraphController : public CAnimGraphControllerBase /*0x0*/  // sizeof 0x2D8, align 0x8 [vtable] (client) {MGetKV3ClassDefaults}
{
public:
    ...
    char _pad_02A0[0x38]; // offset 0x2A0
};
