...
class C_DOTA_Item_Bottomless_Chalice : public C_DOTA_Item /*0x0*/  // sizeof 0x768, align 0x8 [vtable] (client)
{
public:
    ...
    float32 stored_rune_duration; // offset 0x760, size 0x4, align 4
