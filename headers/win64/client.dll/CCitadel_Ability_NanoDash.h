...
class CCitadel_Ability_NanoDash : public C_CitadelBaseAbility /*0x0*/  // sizeof 0x18A8, align 0x8 [vtable] (client) {MNetworkVarNames MNetworkVarNames MNetworkVarNames}
{
public:
    char _pad_0000[0x11D8]; // offset 0x0
    Vector m_vStartPosition; // offset 0x11D8, size 0xC, align 4 | MNetworkEnable MNetworkUserGroup
    Vector m_vEndPosition; // offset 0x11E4, size 0xC, align 4 | MNetworkEnable MNetworkUserGroup
    ...
    char _pad_121C[0x684]; // offset 0x121C
    GameTime_t m_flStuckTime; // offset 0x18A0, size 0x4, align 255
