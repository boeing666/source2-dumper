...
class CDOTA_Modifier_MonkeyKing_FurArmy_SoldierInPosition : public CDOTA_Buff /*0x0*/  // sizeof 0x1AB8, align 0xFF [vtable] (client)
{
public:
    char _pad_0000[0x1A78]; // offset 0x0
    Vector m_vTargetPos; // offset 0x1A78, size 0xC, align 4
    CHandle< C_BaseEntity > m_hAttackTarget; // offset 0x1A84, size 0x4, align 4
    ...
    CHandle< C_BaseEntity > m_hThinker; // offset 0x1AA4, size 0x4, align 4
