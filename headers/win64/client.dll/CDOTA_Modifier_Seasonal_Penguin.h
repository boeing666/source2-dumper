...
class CDOTA_Modifier_Seasonal_Penguin : public CDOTA_Buff /*0x0*/  // sizeof 0x1B20, align 0xFF [vtable] (client)
{
public:
    ...
    CHandle< C_BaseEntity > m_hLastBumpingHero; // offset 0x1AE0, size 0x4, align 4
