...
class C_DOTA_Ability_Frogmen_CongregationOfTheDeep : public C_DOTABaseAbility /*0x0*/  // sizeof 0x6F0, align 0x8 [vtable] (client)
{
public:
    ...
    int32 projectile_count; // offset 0x6D0, size 0x4, align 4
