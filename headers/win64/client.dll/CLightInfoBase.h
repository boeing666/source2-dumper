...
class CLightInfoBase  // sizeof 0x3D0, align 0xFF [vtable] (client)
{
public:
    ...
    char[260] m_pszLightningSound; // offset 0x298, size 0x104, align 1
    float32 m_flNextLightningStartTime; // offset 0x39C, size 0x4, align 4
    float32 m_flNextLightningEndTime; // offset 0x3A0, size 0x4, align 4
    float32 m_flLightningFluctuationTimeStart; // offset 0x3A4, size 0x4, align 4
    float32 m_flLightningFluctuationTimeEnd; // offset 0x3A8, size 0x4, align 4
    float32 m_flLightningNumFluctuations; // offset 0x3AC, size 0x4, align 4
    float32 m_flNextLightningSoundTime; // offset 0x3B0, size 0x4, align 4
    bool m_bPlayLightingSound; // offset 0x3B4, size 0x1, align 1
    char _pad_03B5[0x3]; // offset 0x3B5
    float32 m_flLightningEventMagnitude; // offset 0x3B8, size 0x4, align 4
    float32 m_flLightningScale; // offset 0x3BC, size 0x4, align 4
    float32 m_flLightningFluctuation; // offset 0x3C0, size 0x4, align 4
    float32 m_flLightningAngle; // offset 0x3C4, size 0x4, align 4
    float32 m_flLightningEventPercentage; // offset 0x3C8, size 0x4, align 4
