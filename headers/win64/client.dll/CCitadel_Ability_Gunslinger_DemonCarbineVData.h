...
class CCitadel_Ability_Gunslinger_DemonCarbineVData : public CitadelAbilityVData /*0x0*/  // sizeof 0x18C8, align 0x8 [vtable] (client) {MGetKV3ClassDefaults}
{
public:
    ...
    CitadelCameraOperationsSequence_t m_cameraDemonCarbineShotFired; // offset 0x1840, size 0x88, align 8 | MPropertyStartGroup
};
