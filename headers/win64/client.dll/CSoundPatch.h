...
public:
    ...
    CSoundEnvelope m_pitch; // offset 0x8, size 0x10, align 255
    CSoundEnvelope m_volume; // offset 0x18, size 0x10, align 255
    char _pad_0028[0x14]; // offset 0x28
    float32 m_shutdownTime; // offset 0x3C, size 0x4, align 4 | MKV3TransferSaveOpsForField
    float32 m_flLastTime; // offset 0x40, size 0x4, align 4 | MKV3TransferSaveOpsForField
    ...
    CCopyRecipientFilter m_Filter; // offset 0x68, size 0x38, align 255
