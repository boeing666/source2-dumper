...
class CGlobalLightBase  // sizeof 0x520, align 0xFF [vtable] (client)
{
public:
    ...
    float32 m_fSmoothedAmount; // offset 0x4C0, size 0x4, align 4
    float32 m_fSlowSmoothedAmount; // offset 0x4C4, size 0x4, align 4
    char _pad_04C8[0x58]; // offset 0x4C8
};
