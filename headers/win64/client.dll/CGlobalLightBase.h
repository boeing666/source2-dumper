...
public:
    ...
    Vector m_SpotLightOrigin; // offset 0x14, size 0xC, align 4
    ...
    Vector m_ViewOrigin; // offset 0xD4, size 0xC, align 4
    QAngle m_ViewAngles; // offset 0xE0, size 0xC, align 4
    float32 m_flViewFoV; // offset 0xEC, size 0x4, align 4
    Vector[8] m_WorldPoints; // offset 0xF0, size 0x60, align 4
