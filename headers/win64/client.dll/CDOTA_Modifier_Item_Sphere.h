...
class CDOTA_Modifier_Item_Sphere : public CDOTA_Buff_Item /*0x0*/  // sizeof 0x1A90, align 0xFF [vtable] (client)
{
public:
    ...
    float32 block_cooldown; // offset 0x1A88, size 0x4, align 4
    float32 upgrade_absorb_duration; // offset 0x1A8C, size 0x4, align 4
};
