...
class CDOTA_Modifier_Item_Sphere : public CDOTA_Buff_Item /*0x0*/  // sizeof 0x1A70, align 0xFF [vtable] (client)
{
public:
    ...
    float32 upgrade_absorb_duration; // offset 0x1A6C, size 0x4, align 4
};
