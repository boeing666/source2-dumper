...
class CAbilityRiotProtocolVData : public CitadelAbilityVData /*0x0*/  // sizeof 0x19E8, align 0x8 [vtable] (client) {MGetKV3ClassDefaults}
{
public:
    ...
    CEmbeddedSubclass< CCitadelModifier > m_WardenBuffModifier; // offset 0x19D8, size 0x10, align 8 | MPropertyGroupName
};
