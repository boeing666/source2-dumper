...
class C_DOTA_Ability_Creature_Ice_Breath : public C_DOTABaseAbility /*0x0*/  // sizeof 0x6F0, align 0x8 [vtable] (client)
{
public:
    ...
    float32 slow_duration; // offset 0x6BC, size 0x4, align 4
