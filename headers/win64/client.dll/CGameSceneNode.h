...
class CGameSceneNode  // sizeof 0x150, align 0x10 [vtable] (client) {MGetKV3ClassDefaults}
{
public:
    ...
    char _pad_0120[0x10]; // offset 0x120
    CUtlStringToken m_hierarchyAttachName; // offset 0x130, size 0x4, align 4
    float32 m_flZOffset; // offset 0x134, size 0x4, align 4
    QAngle m_angLocalOrientation; // offset 0x138, size 0xC, align 4
    float32 m_flClientLocalScale; // offset 0x144, size 0x4, align 4
    char _pad_0148[0x8]; // offset 0x148
};
