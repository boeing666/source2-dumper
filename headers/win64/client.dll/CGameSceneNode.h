...
class CGameSceneNode  // sizeof 0x130, align 0x10 [vtable] (client) {MGetKV3ClassDefaults}
{
public:
    ...
    CUtlStringToken m_hierarchyAttachName; // offset 0x120, size 0x4, align 4
    float32 m_flClientLocalScale; // offset 0x124, size 0x4, align 4
    char _pad_0128[0x8]; // offset 0x128
};
