...
class CDOTA_Modifier_Phoenix_Sun : public CDOTA_Buff /*0x0*/  // sizeof 0x1A78, align 0xFF [vtable] (client)
{
public:
    ...
    CHandle< C_BaseEntity > m_hSecondaryTarget; // offset 0x1A6C, size 0x4, align 4
