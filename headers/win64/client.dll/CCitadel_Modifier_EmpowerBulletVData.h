...
class CCitadel_Modifier_EmpowerBulletVData : public CCitadel_Modifier_BaseBulletPreRollProcVData /*0x0*/  // sizeof 0xB50, align 0x8 [vtable] (client) {MGetKV3ClassDefaults}
{
public:
    ...
    CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_EmpowerWeaponParticle; // offset 0xA50, size 0xE0, align 8
