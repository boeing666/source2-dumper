...
class CDOTA_Modifier_Viper_Nose_Dive : public CDOTA_Buff /*0x0*/  // sizeof 0x1A90, align 0xFF [vtable] (client)
{
public:
    ...
    float32 corrosive_radius; // offset 0x1A80, size 0x4, align 4
    float32 effect_duration; // offset 0x1A84, size 0x4, align 4
    float32 dive_speed; // offset 0x1A88, size 0x4, align 4
    float32 start_height; // offset 0x1A8C, size 0x4, align 4
};
