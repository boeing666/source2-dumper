...
class CDOTA_Modifier_Item_SheepStick : public CDOTA_Buff_Item /*0x0*/  // sizeof 0x1A70, align 0xFF [vtable] (client)
{
public:
    ...
    int32 bonus_mana; // offset 0x1A68, size 0x4, align 4
    int32 cast_range_bonus; // offset 0x1A6C, size 0x4, align 4
};
