...
class CCitadel_Modifier_Link : public CCitadelModifier /*0x0*/  // sizeof 0xF8, align 0xFF [vtable] (client)
{
public:
    ...
    VectorWS m_vecLinkPosition; // offset 0xE0, size 0xC, align 4
    char _pad_00EC[0xC]; // offset 0xEC
};
