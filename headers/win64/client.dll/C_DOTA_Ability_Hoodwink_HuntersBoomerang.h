...
class C_DOTA_Ability_Hoodwink_HuntersBoomerang : public C_DOTABaseAbility /*0x0*/  // sizeof 0x6F0, align 0x8 [vtable] (client)
{
public:
    ...
    float32 mark_duration; // offset 0x6B4, size 0x4, align 4
