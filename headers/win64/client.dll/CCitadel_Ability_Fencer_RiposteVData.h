...
class CCitadel_Ability_Fencer_RiposteVData : public CitadelAbilityVData /*0x0*/  // sizeof 0x1B30, align 0x8 [vtable] (client) {MGetKV3ClassDefaults}
{
public:
    ...
    CEmbeddedSubclass< CCitadelModifier > m_TargetLifestealModifier; // offset 0x1B08, size 0x10, align 8
    ...
    float32 m_flParryMoveSpeed; // offset 0x1B24, size 0x4, align 4
    float32 m_flDashAnimDelay; // offset 0x1B28, size 0x4, align 4
