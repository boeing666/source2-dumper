...
class CCitadel_Ability_Gunslinger_DemonCarbine : public C_CitadelBaseAbility /*0x0*/  // sizeof 0x1578, align 0x8 [vtable] (client) {MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames}
{
public:
