...
struct NewSettingsDefinition_t  // sizeof 0x40, align 0x8 (client) {MGetKV3ClassDefaults MVDataRoot}
{
    NewSettingsID_t m_nID; // offset 0x0, size 0x4, align 255 | MPropertyDescription MVDataUniqueMonotonicInt MPropertyAttributeEditor
