...
public:
    ...
    float32 m_flModelScaleIncreasePerAbsorb; // offset 0x288, size 0x4, align 4
    float32 m_flMaxModelScale; // offset 0x28C, size 0x4, align 4
    float32 m_flAbsorbRadius; // offset 0x290, size 0x4, align 4
    float32 m_flPercentHealthAbsorbed; // offset 0x294, size 0x4, align 4
