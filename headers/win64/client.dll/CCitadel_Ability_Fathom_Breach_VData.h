...
class CCitadel_Ability_Fathom_Breach_VData : public CitadelAbilityVData /*0x0*/  // sizeof 0x1A00, align 0x8 [vtable] (client) {MGetKV3ClassDefaults}
{
public:
    ...
    CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_LeapParticle; // offset 0x18F8, size 0xE0, align 8
