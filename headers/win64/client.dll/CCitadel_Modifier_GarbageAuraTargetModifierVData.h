...
class CCitadel_Modifier_GarbageAuraTargetModifierVData : public CCitadel_Modifier_StunnedVData /*0x0*/  // sizeof 0x848, align 0x8 [vtable] (client) {MGetKV3ClassDefaults}
{
public:
