...
struct AI_MotorServices_DebugSnapshotData_t  // sizeof 0x38, align 0x8 (client) {MGetKV3ClassDefaults MPropertyFriendlyName MDebugSnapshotDataRenderFn}
{
    ...
    CUtlString ground_entity_debug_name; // offset 0x30, size 0x8, align 8
};
