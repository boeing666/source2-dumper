...
class CDOTA_Modifier_SkeletonKing_BoneGuard_Summon : public CDOTA_Buff /*0x0*/  // sizeof 0x1A80, align 0xFF [vtable] (client)
{
public:
    ...
    float32 vampiric_aura; // offset 0x1A68, size 0x4, align 4
    ...
    int32 m_nVampiricAura; // offset 0x1A7C, size 0x4, align 4
};
