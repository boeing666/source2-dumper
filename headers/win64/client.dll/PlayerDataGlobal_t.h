...
struct PlayerDataGlobal_t  // sizeof 0x340, align 0xFF [vtable] (client) {MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames MNetworkVarNames}
{
    ...
    C_NetworkUtlVectorBase< CUtlStringToken > m_vecUpgrades; // offset 0x98, size 0x18, align 8 | MNetworkEnable MNetworkUserGroup MNetworkChangeCallback
    C_NetworkUtlVectorBase< CUtlStringToken > m_vecBonusCounterAbilities; // offset 0xB0, size 0x18, align 8 | MNetworkEnable
    C_NetworkUtlVectorBase< int32 > m_vecBonusCounterValues; // offset 0xC8, size 0x18, align 8 | MNetworkEnable MNetworkUserGroup MNetworkChangeCallback
    C_NetworkUtlVectorBase< CUtlStringToken > m_vecBonusCounterModifiers; // offset 0xE0, size 0x18, align 8 | MNetworkEnable
    C_NetworkUtlVectorBase< int32 > m_vecModifierBonusCounterValues; // offset 0xF8, size 0x18, align 8 | MNetworkEnable MNetworkUserGroup MNetworkChangeCallback
    ...
    C_UtlVectorEmbeddedNetworkVar< ItemImbuementPair_t > m_vecImbuements; // offset 0x118, size 0x68, align 8 | MNetworkEnable
    C_UtlVectorEmbeddedNetworkVar< DynamicAbilityValues_t > m_vecDynamicAbilityValues; // offset 0x180, size 0x68, align 8 | MNetworkEnable
    C_UtlVectorEmbeddedNetworkVar< StatViewerModifierValues_t > m_vecStatViewerModifierValues; // offset 0x1E8, size 0x68, align 8 | MNetworkEnable
    C_UtlVectorEmbeddedNetworkVar< StolenAbilityPair_t > m_vecStolenAbilities; // offset 0x250, size 0x68, align 8 | MNetworkEnable MNetworkUserGroup MNetworkChangeCallback
    C_UtlVectorEmbeddedNetworkVar< AbilityUpgradeState_t > m_vecAbilityUpgradeState; // offset 0x2B8, size 0x68, align 8 | MNetworkEnable MNetworkUserGroup MNetworkChangeCallback
