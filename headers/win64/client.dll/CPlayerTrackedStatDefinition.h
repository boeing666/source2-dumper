...
class CPlayerTrackedStatDefinition  // sizeof 0x28, align 0x8 (client) {MGetKV3ClassDefaults MVDataRoot}
{
public:
    ...
    TrackedStatHeroAdjectiveData_t m_heroAdjectiveData; // offset 0x20, size 0x8, align 8 | MPropertyDescription MPropertySuppressExpr
};
