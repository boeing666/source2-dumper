...
public:
    ...
    bool m_bSmokeVolumeDataReceived; // offset 0x13A8, size 0x1, align 1
    bool m_bSmokeEffectSpawned; // offset 0x13A9, size 0x1, align 1
    char _pad_13AA[0x156]; // offset 0x13AA
};
