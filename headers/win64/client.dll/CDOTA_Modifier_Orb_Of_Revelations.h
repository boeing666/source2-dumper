...
class CDOTA_Modifier_Orb_Of_Revelations : public CDOTA_Buff_Item /*0x0*/  // sizeof 0x1A90, align 0xFF [vtable] (client)
{
public:
    ...
    int32 bonus_magical_armor; // offset 0x1A88, size 0x4, align 4
