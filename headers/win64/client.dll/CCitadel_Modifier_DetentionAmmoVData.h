...
class CCitadel_Modifier_DetentionAmmoVData : public CCitadel_Modifier_BaseEventProcVData /*0x0*/  // sizeof 0x890, align 0x8 [vtable] (client) {MGetKV3ClassDefaults}
{
public:
    ...
    CEmbeddedSubclass< CCitadelModifier > m_DebuffModifier; // offset 0x790, size 0x10, align 8
