...
class CAttributeManager  // sizeof 0x68, align 0xFF [vtable] (client) {MNetworkVarNames MNetworkVarNames MNetworkVarNames}
{
public:
    ...
    CHandle< C_BaseEntity > m_hOuter; // offset 0x3C, size 0x4, align 4 | MNetworkEnable
