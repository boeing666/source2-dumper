...
class CDOTA_Modifier_Item_Naginata : public CDOTA_Buff_Item /*0x0*/  // sizeof 0x1A78, align 0xFF [vtable] (client)
{
public:
    ...
    int32 cooldown_reduction_percent; // offset 0x1A6C, size 0x4, align 4
    int32 bonus_chance; // offset 0x1A70, size 0x4, align 4
