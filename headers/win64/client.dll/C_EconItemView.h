...
class C_EconItemView : public IEconItemInterface /*0x0*/  // sizeof 0x5B0, align 0xFF [vtable] (client)
{
public:
    ...
    char[161] m_szCustomNameOverride2; // offset 0x43A, size 0xA1, align 1
    char[161] m_szCustomNameOverride3; // offset 0x4DB, size 0xA1, align 1
    char _pad_057C[0x2C]; // offset 0x57C
    bool m_bInitializedTags; // offset 0x5A8, size 0x1, align 1
