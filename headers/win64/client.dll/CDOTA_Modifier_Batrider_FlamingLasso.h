...
class CDOTA_Modifier_Batrider_FlamingLasso : public CDOTA_Buff /*0x0*/  // sizeof 0x1A78, align 0xFF [vtable] (client)
{
public:
    ...
    VectorWS vPreviousLocation; // offset 0x1A68, size 0xC, align 4
