...
class CSmartPropOperation_SavePosition : public CSmartPropOperation /*0x0*/  // sizeof 0x98, align 0x8 [vtable] (smartprops) {MGetKV3ClassDefaults MPropertyFriendlyName MPropertyDescription MVDataClassGroup}
{
public:
