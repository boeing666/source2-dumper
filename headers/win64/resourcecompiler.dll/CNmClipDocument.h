...
class CNmClipDocument : public CNmAnimDocument /*0x0*/  // sizeof 0xF8, align 0x8 [vtable] (animdoclib) {MGetKV3ClassDefaults}
{
public:
    ...
    CUtlString m_additiveBaseFilename; // offset 0xB8, size 0x8, align 8 | MPropertyGroupName MPropertyAttributeEditor MPropertyDescription MPropertyAttrStateCallback
    CNmClipDocument::AdditiveBaseFrame_t m_additiveBaseFrame; // offset 0xC0, size 0x1, align 1 | MPropertyGroupName MPropertyDescription MPropertyAttrStateCallback
    char _pad_00C1[0x3]; // offset 0xC1
    int32 m_nAdditiveBaseFrameIdx; // offset 0xC4, size 0x4, align 4 | MPropertyGroupName MPropertyDescription MPropertyAttrStateCallback
    bool m_bUseReferencePoseForSecondaryAnimAdditives; // offset 0xC8, size 0x1, align 1 | MPropertyGroupName MPropertyDescription MPropertyAttrStateCallback
    char _pad_00C9[0x7]; // offset 0xC9
    CUtlVector< CUtlString > m_bonesToSampleInModelSpace; // offset 0xD0, size 0x18, align 8 | MPropertyGroupName MPropertyAutoExpandSelf MPropertyDescription
