...
class CNmGraphDocGraphEventConditionNode : public CNmGraphDocFlowNode /*0x0*/  // sizeof 0x128, align 0x8 [vtable] (animdoclib) {MGetKV3ClassDefaults}
{
public:
    ...
    CUtlVector< CNmGraphDocGraphEventConditionNode::Condition_t > m_conditions; // offset 0x110, size 0x18, align 8 | MPropertyGroupName MPropertyAutoExpandSelf
};
