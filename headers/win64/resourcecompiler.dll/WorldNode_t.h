...
struct WorldNode_t  // sizeof 0x178, align 0x8 (resourcecompiler) {MGetKV3ClassDefaults}
{
    ...
    CUtlVector< CUtlString > m_layerNames; // offset 0xF0, size 0x18, align 8
    CUtlVector< uint8 > m_sceneObjectLayerIndices; // offset 0x108, size 0x18, align 8
    CUtlString m_grassFileName; // offset 0x120, size 0x8, align 8
    BakedLightingInfo_t m_nodeLightingInfo; // offset 0x128, size 0x48, align 8
    bool m_bHasBakedGeometryFlag; // offset 0x170, size 0x1, align 1
