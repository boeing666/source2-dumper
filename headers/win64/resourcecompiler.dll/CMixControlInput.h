...
class CMixControlInput : public CMixPropertyBase /*0x0*/  // sizeof 0x30, align 0x8 [vtable] (sounddoc_lib) {MGetKV3ClassDefaults MPropertyFriendlyName MPropertyDescription}
{
public:
    ...
    bool m_bUseDecibels; // offset 0x2C, size 0x1, align 1 | MPropertyFriendlyName
