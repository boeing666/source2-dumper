...
class CMixBoxverb : public CMixPropertyBase /*0x0*/  // sizeof 0x70, align 0x8 [vtable] (sounddoc_lib) {MGetKV3ClassDefaults MPropertyFriendlyName MPropertyDescription}
{
public:
    ...
    float32 m_flOutputGain; // offset 0x64, size 0x4, align 4 | MPropertyDescription MPropertyFriendlyName MPropertyAttributeRange
    float32 m_flTaps; // offset 0x68, size 0x4, align 4 | MPropertyDescription MPropertyFriendlyName MPropertyAttributeRange
