...
struct BakedLightingInfo_t  // sizeof 0x48, align 0x8 (resourcecompiler) {MGetKV3ClassDefaults}
{
    ...
    int8 m_nLPVEncoding; // offset 0x13, size 0x1, align 1
    int8 m_nLightmapEncoding; // offset 0x14, size 0x1, align 1
    uint8 m_nChartPackIterations; // offset 0x15, size 0x1, align 1
    uint8 m_nVradQuality; // offset 0x16, size 0x1, align 1
