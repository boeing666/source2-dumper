...
struct AggregateMeshInfo_t  // sizeof 0x24, align 0x4 [trivial_dtor] (resourcecompiler) {MGetKV3ClassDefaults}
{
    ...
    AggregateInstanceStream_t m_instanceStreams; // offset 0x20, size 0x1, align 1
