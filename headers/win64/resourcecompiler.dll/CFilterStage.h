...
public:
    ...
    VMixFilterChannelSet_t m_nChannelSet; // offset 0x15, size 0x1, align 1 | MPropertyFriendlyName
    bool m_bEnable; // offset 0x16, size 0x1, align 1 | MPropertyFriendlyName
