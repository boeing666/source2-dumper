...
class CAnimGraphDoc_SubtractNode : public CAnimGraphDoc_Node /*0x0*/  // sizeof 0x68, align 0x8 [vtable] (animgraphdoclib) {MGetKV3ClassDefaults MPropertyFriendlyName}
{
public:
    char _pad_0000[0x40]; // offset 0x0
    CAnimGraphDoc_NodeConnection m_baseInputConnection; // offset 0x40, size 0x8, align 4 | MPropertySuppressField
    CAnimGraphDoc_NodeConnection m_subtractInputConnection; // offset 0x48, size 0x8, align 4 | MPropertySuppressField
    ...
    bool m_bResetSubtract; // offset 0x5E, size 0x1, align 1 | MPropertyFriendlyName
