...
class CRemapValueItem  // sizeof 0x48, align 0x8 (animgraphdoclib) {MGetKV3ClassDefaults MPropertyFriendlyName}
{
public:
    RemapValueType m_valueType; // offset 0x0, size 0x4, align 4 | MPropertyFriendlyName MPropertyAutoRebuildOnChange
    ...
    float32 m_flMinInputValue; // offset 0x38, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_flMaxInputValue; // offset 0x3C, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_flMinOutputValue; // offset 0x40, size 0x4, align 4 | MPropertyFriendlyName
    float32 m_flMaxOutputValue; // offset 0x44, size 0x4, align 4 | MPropertyFriendlyName
};
