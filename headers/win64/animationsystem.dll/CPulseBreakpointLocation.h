...
class CPulseBreakpointLocation  // sizeof 0x30, align 0x8 [trivial_dtor] (pulse_runtime_lib) {MGetKV3ClassDefaults}
{
public:
    ...
    bool m_bDeferBreak; // offset 0x28, size 0x1, align 1
