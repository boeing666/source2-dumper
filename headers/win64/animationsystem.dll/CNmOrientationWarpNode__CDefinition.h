...
class CNmOrientationWarpNode::CDefinition : public CNmPoseNode::CDefinition /*0x0*/  // sizeof 0x20, align 0x8 [vtable] (animlib) {MGetKV3ClassDefaults}
{
public:
    ...
    CNmOrientationWarpNode::AlignmentMode_t m_alignmentMode; // offset 0x17, size 0x1, align 1
    CNmRootMotionData::SamplingMode_t m_samplingMode; // offset 0x18, size 0x1, align 1
