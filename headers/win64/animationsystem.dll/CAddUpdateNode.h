...
class CAddUpdateNode : public CBinaryUpdateNode /*0x0*/  // sizeof 0xA0, align 0x8 [vtable] (animgraphlib) {MGetKV3ClassDefaults}
{
public:
    ...
    bool m_bApplyScale; // offset 0x9B, size 0x1, align 1
